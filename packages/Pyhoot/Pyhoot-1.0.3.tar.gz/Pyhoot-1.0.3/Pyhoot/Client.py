...
class Client():
    def __init__(self, gamepin=None, name="bot",quizuuid=None,random_text="Hello, I am a bot and can not answer this question",auth_bypass=True):
        self.data = {}
        self.sent = {}
        ...
        self.listening_types=["pinged","handshake_1","handshake_2","avatar_updated", "disconnected", "question_started", "question_ended", "question_awaited", "quiz_started", "quiz_ended", "unknown_message","connected","auth_reset","auth_correct","auth_incorrect"]
    ...
    def MessageHandler(self):
        ...
        id=data.get("id")
        event_map={14:"handshake2",46:"avatar_updated",10:"disconnected",2:"question_awaited",8:"question_ended",9:"quiz_started",13:"quiz_ended",53:"auth_reset",52:"auth_correct",51:"auth_incorrect"}
        info=self.data
        del info["ext"]
        del info["channel"]
        ...
        if id in event_map:
            if id==10:
                ...
                self.send([{"id":str(self.message_count),"channel":"/service/controller","data":{"id":16,"type":"message","gameid":str(self.gamepin),"host":"kahoot.it","content":JSON.dumps({"stableIdentifier":self.stableid,"usingNamerator":False})},"clientId":str(self.clientId),"ext":{}}])
            ...
            self.latest_listener_call="connected"
            func=self.listening_functions.get("connected")
        else:
    ...
    def join(self, name="",profile="",quizuuid=None):
        ...
        if self.game_info.get("twoFactorAuth") is True:
            if self.auth_bypass:
                ...
                self.exception_handler(Exceptions.AuthBypassFalseError,self.gamepin)
        else:
            self.auth_correct.set()

...
contents, format and handling of JSET files.
...
.. autoclass:: jetto_tools.template.Template
    :members: __init__, jset, namelist, lookup, sanco_namelist, extra_files, is_regular_param, validate_regular_param, validate_extra_namelist_param, validate_extra_namelist_param_details

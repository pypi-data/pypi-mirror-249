...
from airclick.utils import screen_utils
from airclick.daos.screen_daos import Point, OcrRes
import numpy as np

from airclick.utils.screen_utils import compare_colors
from airclick.windows.system import R
from airclick.utils import airclickcv as aircv


def capture(hwnd: int = 0, rect=None) -> Image:
    temp_img = None
    if hwnd != 0:
...
class CompareColors:
    ...
    def compare(self):
        ...
        return compare_colors(self.colors, self.sim, img)

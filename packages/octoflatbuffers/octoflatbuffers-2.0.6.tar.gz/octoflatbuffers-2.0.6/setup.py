...
setup(
    ...
    long_description=(
        'A fork of [flatbuffers](https://flatbuffers.dev/) with some special modifications for use as the core protocol for [OctoEverywhere](https://octoeverywhere.com) and [Homeway.io](https://homeway.io). For details on why the fork was needed, see the source GitHub repository.'),

...
from openaoe.backend.config.biz_config import get_configuration, get_base_url
...
def spark_chat_svc(request: Request, req_dto: XunfeiSparkChatReqDto):
    ...
    app_id = get_configuration(VENDOR_XUNFEI, "app_id")
    ak = get_configuration(VENDOR_XUNFEI, "ak")
    sk = get_configuration(VENDOR_XUNFEI, "sk")

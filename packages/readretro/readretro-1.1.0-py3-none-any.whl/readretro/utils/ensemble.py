...
def prepare_ensemble(retroformer_ckpt='.', g2s_ckpt='.', cuda=False, beam_size=10, expansion_topk=10):
    model_retroformer, args_retroformer = prepare_retroformer(cuda, beam_size, expansion_topk,retroformer_ckpt)
    model_g2s, args_g2s, vocab, vocab_tokens, device = prepare_g2s(cuda, 200, expansion_topk,g2s_ckpt)

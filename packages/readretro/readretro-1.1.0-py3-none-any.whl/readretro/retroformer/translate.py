...
def prepare_retroformer(cuda=True, beam_size=10, expansion_topk=10,ckpt='.'):
    args = EasyDict()
    ...
    args.vocab = 'saved_models/vocab_share.pk'
    args.vocab = os.path.join(script_dir,args.vocab)

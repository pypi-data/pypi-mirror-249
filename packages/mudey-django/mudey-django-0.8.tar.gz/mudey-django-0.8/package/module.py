import argparse
from package.model_generator import generate_model
from package.view_generator import generate_templates, generate_view
from package.form_generator import generate_form

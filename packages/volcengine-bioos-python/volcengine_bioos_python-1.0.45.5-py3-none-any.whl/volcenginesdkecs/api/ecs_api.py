...
class ECSApi(object):
    ...
    def associate_instances_iam_role_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('body' not in params or
            ...
            raise ValueError(
                "Missing the required parameter `body` when calling `associate_instances_iam_role`")  # noqa: E501
    ...
    def describe_available_resource_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError(
                "Missing the required parameter `body` when calling `describe_available_resource`")  # noqa: E501
    ...
    def describe_cloud_assistant_status_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError(
                "Missing the required parameter `body` when calling `describe_cloud_assistant_status`")  # noqa: E501
    ...
    def describe_deployment_set_supported_instance_type_family(self, body, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.describe_deployment_set_supported_instance_type_family_with_http_info(body,
                                                                                              **kwargs)  # noqa: E501
        else:
            (data) = self.describe_deployment_set_supported_instance_type_family_with_http_info(body,
                                                                                                **kwargs)  # noqa: E501
            return data
    ...
    def describe_deployment_set_supported_instance_type_family_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError(
                "Missing the required parameter `body` when calling `describe_deployment_set_supported_instance_type_family`")  # noqa: E501
    ...
    def run_instances_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        try:
            ...
            # Unknown Error 表示 bio ecs 服务器返回未知报错
            if hasattr(bio_error, 'body') and isinstance(bio_error.body, str) \
                    and 'Unknown Error' not in bio_error.body:

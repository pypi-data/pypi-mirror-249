...
from skriba.custom.console import add_verbose_info
...
class LoggingFormatter(logging.Formatter):
    ...
    FORMATS = {
        ...
        logging.CRITICAL: start_msg + colorize.format(text=middle_msg, color=[220, 60, 20], highlight=True) + colorize.grey("  %(name)10s: ") + " %(message)s",
    }

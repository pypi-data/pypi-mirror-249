...
class fxstlistException(Exception):
    """Base exception class for all fxstlist exceptions."""


class ConvertTimeError(fxstlistException):
    """Raised when a time conversion fails."""


class Blacklisted(fxstlistException):

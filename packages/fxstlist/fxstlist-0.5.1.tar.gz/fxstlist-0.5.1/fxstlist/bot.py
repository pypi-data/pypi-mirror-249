...
class Bot(_main_bot):  # type: ignore
    """The fxstlist bot class. This is a subclass of :class:`discord.Bot` if you use Pycord.
    ...
    **kwargs:
    ...
    def add_help_command(
        ...
        **kwargs:
        ...
        if not DPY:
            self.load_extension("fxstlist.cogs.pyc.help_setup", package="fxstlist")
    ...
    def add_status_changer(
        ...
        **kwargs:
        ...
        if not DPY:
            self.load_extension("fxstlist.cogs.pyc.status_changer_setup", package="fxstlist")
    ...
    def add_blacklist(
        ...
        **kwargs:
        ...
        if not DPY:
            self.load_extension("fxstlist.cogs.pyc.blacklist_setup", package="fxstlist")
    ...
    async def setup_hook(self):
        ...
        for ext in self.enabled_extensions:
            await self.load_extension(f".cogs.dpy.{ext}_setup", package="fxstlist")
...
class PrefixBot(Bot, commands.Bot):
    ...
    This class can be used if you want to use fxstlist with prefix commands.
...
class BridgeBot(Bot, bridge.Bot):
    ...
    This class can be used if you want to use fxstlist with bridge commands.
    This is only needed for Pycord.
    """

...
Refer to the Terraform Registory for docs: [`azurerm_cosmosdb_gremlin_graph`](https://registry.terraform.io/providers/hashicorp/azurerm/3.86.0/docs/resources/cosmosdb_gremlin_graph).
'''
import abc
import builtins
import datetime

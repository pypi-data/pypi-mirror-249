...
Refer to the Terraform Registory for docs: [`azurerm_storage_blob_inventory_policy`](https://registry.terraform.io/providers/hashicorp/azurerm/3.86.0/docs/resources/storage_blob_inventory_policy).
'''
import abc
import builtins
import datetime

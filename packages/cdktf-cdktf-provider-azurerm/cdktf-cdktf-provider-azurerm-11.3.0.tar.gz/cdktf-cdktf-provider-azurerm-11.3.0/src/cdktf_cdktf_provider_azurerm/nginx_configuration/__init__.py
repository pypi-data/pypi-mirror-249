...
Refer to the Terraform Registory for docs: [`azurerm_nginx_configuration`](https://registry.terraform.io/providers/hashicorp/azurerm/3.86.0/docs/resources/nginx_configuration).
'''
import abc
import builtins
import datetime

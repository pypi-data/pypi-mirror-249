...
Refer to the Terraform Registory for docs: [`data_azurerm_maintenance_configuration`](https://registry.terraform.io/providers/hashicorp/azurerm/3.86.0/docs/data-sources/maintenance_configuration).
'''
import abc
import builtins
import datetime

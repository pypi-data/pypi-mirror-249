...
Refer to the Terraform Registory for docs: [`azurerm_marketplace_agreement`](https://registry.terraform.io/providers/hashicorp/azurerm/3.86.0/docs/resources/marketplace_agreement).
'''
import abc
import builtins
import datetime

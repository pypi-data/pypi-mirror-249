...
Refer to the Terraform Registory for docs: [`azurerm_subnet_service_endpoint_storage_policy`](https://registry.terraform.io/providers/hashicorp/azurerm/3.86.0/docs/resources/subnet_service_endpoint_storage_policy).
'''
import abc
import builtins
import datetime

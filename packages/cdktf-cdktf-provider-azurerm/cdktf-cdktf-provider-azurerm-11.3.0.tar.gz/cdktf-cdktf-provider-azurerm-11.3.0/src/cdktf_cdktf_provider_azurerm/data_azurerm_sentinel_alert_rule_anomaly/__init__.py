...
Refer to the Terraform Registory for docs: [`data_azurerm_sentinel_alert_rule_anomaly`](https://registry.terraform.io/providers/hashicorp/azurerm/3.86.0/docs/data-sources/sentinel_alert_rule_anomaly).
'''
import abc
import builtins
import datetime

...
Refer to the Terraform Registory for docs: [`azurerm_kusto_eventhub_data_connection`](https://registry.terraform.io/providers/hashicorp/azurerm/3.86.0/docs/resources/kusto_eventhub_data_connection).
'''
import abc
import builtins
import datetime

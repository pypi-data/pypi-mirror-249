...
Refer to the Terraform Registory for docs: [`data_azurerm_role_definition`](https://registry.terraform.io/providers/hashicorp/azurerm/3.86.0/docs/data-sources/role_definition).
'''
import abc
import builtins
import datetime

...
Refer to the Terraform Registory for docs: [`azurerm_hpc_cache_access_policy`](https://registry.terraform.io/providers/hashicorp/azurerm/3.86.0/docs/resources/hpc_cache_access_policy).
'''
import abc
import builtins
import datetime

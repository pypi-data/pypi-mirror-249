...
Refer to the Terraform Registory for docs: [`data_azurerm_automation_variables`](https://registry.terraform.io/providers/hashicorp/azurerm/3.86.0/docs/data-sources/automation_variables).
'''
import abc
import builtins
import datetime

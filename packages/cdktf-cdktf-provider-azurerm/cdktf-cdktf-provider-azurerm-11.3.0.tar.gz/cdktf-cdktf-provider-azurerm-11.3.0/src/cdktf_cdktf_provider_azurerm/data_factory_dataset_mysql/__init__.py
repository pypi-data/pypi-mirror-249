...
Refer to the Terraform Registory for docs: [`azurerm_data_factory_dataset_mysql`](https://registry.terraform.io/providers/hashicorp/azurerm/3.86.0/docs/resources/data_factory_dataset_mysql).
'''
import abc
import builtins
import datetime

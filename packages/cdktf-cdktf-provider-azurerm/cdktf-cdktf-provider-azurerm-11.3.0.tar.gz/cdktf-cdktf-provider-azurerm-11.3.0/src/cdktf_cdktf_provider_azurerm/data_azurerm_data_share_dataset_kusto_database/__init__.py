...
Refer to the Terraform Registory for docs: [`data_azurerm_data_share_dataset_kusto_database`](https://registry.terraform.io/providers/hashicorp/azurerm/3.86.0/docs/data-sources/data_share_dataset_kusto_database).
'''
import abc
import builtins
import datetime

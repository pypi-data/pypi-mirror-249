...
Refer to the Terraform Registory for docs: [`azurerm_dns_a_record`](https://registry.terraform.io/providers/hashicorp/azurerm/3.86.0/docs/resources/dns_a_record).
'''
import abc
import builtins
import datetime

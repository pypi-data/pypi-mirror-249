...
Refer to the Terraform Registory for docs: [`azurerm_management_lock`](https://registry.terraform.io/providers/hashicorp/azurerm/3.86.0/docs/resources/management_lock).
'''
import abc
import builtins
import datetime

...
Refer to the Terraform Registory for docs: [`azurerm_kubernetes_cluster_extension`](https://registry.terraform.io/providers/hashicorp/azurerm/3.86.0/docs/resources/kubernetes_cluster_extension).
'''
import abc
import builtins
import datetime

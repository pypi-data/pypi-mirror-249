...
Refer to the Terraform Registory for docs: [`azurerm_api_management_tag`](https://registry.terraform.io/providers/hashicorp/azurerm/3.86.0/docs/resources/api_management_tag).
'''
import abc
import builtins
import datetime

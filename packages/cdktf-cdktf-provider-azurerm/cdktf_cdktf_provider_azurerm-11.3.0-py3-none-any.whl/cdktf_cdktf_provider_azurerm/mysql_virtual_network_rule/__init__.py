...
Refer to the Terraform Registory for docs: [`azurerm_mysql_virtual_network_rule`](https://registry.terraform.io/providers/hashicorp/azurerm/3.86.0/docs/resources/mysql_virtual_network_rule).
'''
import abc
import builtins
import datetime

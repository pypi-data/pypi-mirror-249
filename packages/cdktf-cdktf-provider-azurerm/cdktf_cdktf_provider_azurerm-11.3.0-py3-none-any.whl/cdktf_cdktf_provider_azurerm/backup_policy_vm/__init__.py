...
Refer to the Terraform Registory for docs: [`azurerm_backup_policy_vm`](https://registry.terraform.io/providers/hashicorp/azurerm/3.86.0/docs/resources/backup_policy_vm).
'''
import abc
import builtins
import datetime

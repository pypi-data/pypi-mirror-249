...
Refer to the Terraform Registory for docs: [`azurerm_signalr_shared_private_link_resource`](https://registry.terraform.io/providers/hashicorp/azurerm/3.86.0/docs/resources/signalr_shared_private_link_resource).
'''
import abc
import builtins
import datetime

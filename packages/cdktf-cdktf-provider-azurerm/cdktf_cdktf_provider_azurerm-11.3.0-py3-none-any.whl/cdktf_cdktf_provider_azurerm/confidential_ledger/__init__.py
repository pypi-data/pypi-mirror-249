...
Refer to the Terraform Registory for docs: [`azurerm_confidential_ledger`](https://registry.terraform.io/providers/hashicorp/azurerm/3.86.0/docs/resources/confidential_ledger).
'''
import abc
import builtins
import datetime

...
Refer to the Terraform Registory for docs: [`azurerm_shared_image_gallery`](https://registry.terraform.io/providers/hashicorp/azurerm/3.86.0/docs/resources/shared_image_gallery).
'''
import abc
import builtins
import datetime

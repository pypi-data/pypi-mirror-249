...
Refer to the Terraform Registory for docs: [`data_azurerm_active_directory_domain_service`](https://registry.terraform.io/providers/hashicorp/azurerm/3.86.0/docs/data-sources/active_directory_domain_service).
'''
import abc
import builtins
import datetime

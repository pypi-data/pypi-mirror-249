...
Refer to the Terraform Registory for docs: [`azurerm_dns_mx_record`](https://registry.terraform.io/providers/hashicorp/azurerm/3.86.0/docs/resources/dns_mx_record).
'''
import abc
import builtins
import datetime

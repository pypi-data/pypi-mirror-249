...
Refer to the Terraform Registory for docs: [`azurerm_spring_cloud_api_portal`](https://registry.terraform.io/providers/hashicorp/azurerm/3.86.0/docs/resources/spring_cloud_api_portal).
'''
import abc
import builtins
import datetime

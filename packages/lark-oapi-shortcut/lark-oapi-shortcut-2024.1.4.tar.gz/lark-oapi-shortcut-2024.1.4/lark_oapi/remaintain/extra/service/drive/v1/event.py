...
class FileDeletedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, FileDeletedEvent) -> Any
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(
            conf, "drive.file.deleted_v1", handler.handle, clazz=FileDeletedEvent
        )
...
class FilePermissionMemberAddedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, FilePermissionMemberAddedEvent) -> Any
        return self.handler(ctx, conf, event)
...
class FilePermissionMemberRemovedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, FilePermissionMemberRemovedEvent) -> Any
        return self.handler(ctx, conf, event)
...
class FileReadEventHandler:
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(
            conf, "drive.file.read_v1", handler.handle, clazz=FileReadEvent
        )
...
class FileTitleUpdatedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, FileTitleUpdatedEvent) -> Any
        return self.handler(ctx, conf, event)
...
class FileTrashedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, FileTrashedEvent) -> Any
        return self.handler(ctx, conf, event)
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(
            conf, "drive.file.trashed_v1", handler.handle, clazz=FileTrashedEvent
        )
...
class FileEditEventHandler:
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(
            conf, "drive.file.edit_v1", handler.handle, clazz=FileEditEvent
        )

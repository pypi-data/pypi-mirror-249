...
class AppStatusChangeEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, AppStatusChangeEvent) -> Any
        return self.handler(ctx, conf, event)
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(
            conf, "app_status_change", handler.handle, clazz=AppStatusChangeEvent
        )
...
class AppUninstalledEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, AppUninstalledEvent) -> Any
        return self.handler(ctx, conf, event)
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(
            conf, "app_uninstalled", handler.handle, clazz=AppUninstalledEvent
        )
...
class OrderPaidEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, OrderPaidEvent) -> Any
        return self.handler(ctx, conf, event)

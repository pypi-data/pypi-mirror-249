...
class MeetingRoomStatusChangedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, MeetingRoomStatusChangedEvent) -> Any
...
class MeetingRoomCreatedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, MeetingRoomCreatedEvent) -> Any
        return self.handler(ctx, conf, event)
...
class MeetingRoomDeletedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, MeetingRoomDeletedEvent) -> Any
        return self.handler(ctx, conf, event)
...
class MeetingRoomUpdatedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, MeetingRoomUpdatedEvent) -> Any
        return self.handler(ctx, conf, event)
...
class RoomCreatedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, RoomCreatedEvent) -> Any
        return self.handler(ctx, conf, event)
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(
            conf, "meeting_room.room.created_v1", handler.handle, clazz=RoomCreatedEvent
        )
...
class RoomDeletedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, RoomDeletedEvent) -> Any
        return self.handler(ctx, conf, event)
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(
            conf, "meeting_room.room.deleted_v1", handler.handle, clazz=RoomDeletedEvent
        )
...
class RoomStatusChangedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, RoomStatusChangedEvent) -> Any
        return self.handler(ctx, conf, event)
...
class RoomUpdatedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, RoomUpdatedEvent) -> Any
        return self.handler(ctx, conf, event)
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(
            conf, "meeting_room.room.updated_v1", handler.handle, clazz=RoomUpdatedEvent
        )

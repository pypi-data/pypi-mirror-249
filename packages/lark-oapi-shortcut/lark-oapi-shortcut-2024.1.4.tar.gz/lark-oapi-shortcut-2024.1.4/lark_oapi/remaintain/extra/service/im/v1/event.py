...
class ChatUpdatedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, ChatUpdatedEvent) -> Any
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(
            conf, "im.chat.updated_v1", handler.handle, clazz=ChatUpdatedEvent
        )
...
class ChatDisbandedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, ChatDisbandedEvent) -> Any
        return self.handler(ctx, conf, event)
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(
            conf, "im.chat.disbanded_v1", handler.handle, clazz=ChatDisbandedEvent
        )
...
class ChatMemberBotAddedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, ChatMemberBotAddedEvent) -> Any
        return self.handler(ctx, conf, event)
...
class ChatMemberBotDeletedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, ChatMemberBotDeletedEvent) -> Any
        return self.handler(ctx, conf, event)
...
class ChatMemberUserAddedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, ChatMemberUserAddedEvent) -> Any
        return self.handler(ctx, conf, event)
...
class ChatMemberUserWithdrawnEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, ChatMemberUserWithdrawnEvent) -> Any
        return self.handler(ctx, conf, event)
...
class ChatMemberUserDeletedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, ChatMemberUserDeletedEvent) -> Any
        return self.handler(ctx, conf, event)
...
class MessageReceiveEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, MessageReceiveEvent) -> Any
        return self.handler(ctx, conf, event)
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(
            conf, "im.message.receive_v1", handler.handle, clazz=MessageReceiveEvent
        )
...
class MessageMessageReadEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, MessageMessageReadEvent) -> Any
        return self.handler(ctx, conf, event)

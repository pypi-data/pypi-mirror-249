...
class MeetingLeaveMeetingEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, MeetingLeaveMeetingEvent) -> Any
...
class MeetingMeetingEndedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, MeetingMeetingEndedEvent) -> Any
        return self.handler(ctx, conf, event)
...
class MeetingMeetingStartedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, MeetingMeetingStartedEvent) -> Any
        return self.handler(ctx, conf, event)
...
class MeetingRecordingEndedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, MeetingRecordingEndedEvent) -> Any
        return self.handler(ctx, conf, event)
...
class MeetingShareEndedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, MeetingShareEndedEvent) -> Any
        return self.handler(ctx, conf, event)
...
class MeetingJoinMeetingEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, MeetingJoinMeetingEvent) -> Any
        return self.handler(ctx, conf, event)
...
class MeetingRecordingStartedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, MeetingRecordingStartedEvent) -> Any
        return self.handler(ctx, conf, event)
...
class MeetingShareStartedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, MeetingShareStartedEvent) -> Any
        return self.handler(ctx, conf, event)
...
class MeetingRecordingReadyEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, MeetingRecordingReadyEvent) -> Any
        return self.handler(ctx, conf, event)

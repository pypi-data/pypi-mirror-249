...
class DocMetaResult:
    ...
    create_user_name = attr.ib(
        type=str, default=None, metadata={"json": "create_user_name"}
    )
    ...
    edit_user_name = attr.ib(
        type=str, default=None, metadata={"json": "edit_user_name"}
    )
    ...
    owner_user_name = attr.ib(
        type=str, default=None, metadata={"json": "owner_user_name"}
    )

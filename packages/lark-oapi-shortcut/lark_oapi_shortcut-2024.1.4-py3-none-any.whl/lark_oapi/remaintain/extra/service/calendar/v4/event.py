...
class CalendarChangedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, CalendarChangedEvent) -> Any
...
class CalendarAclCreatedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, CalendarAclCreatedEvent) -> Any
        return self.handler(ctx, conf, event)
...
class CalendarAclDeletedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, CalendarAclDeletedEvent) -> Any
        return self.handler(ctx, conf, event)
...
class CalendarEventChangedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, CalendarEventChangedEvent) -> Any
        return self.handler(ctx, conf, event)

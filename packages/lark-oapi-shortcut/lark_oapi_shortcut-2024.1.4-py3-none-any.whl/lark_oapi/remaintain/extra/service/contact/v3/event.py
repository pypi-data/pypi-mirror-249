...
class DepartmentCreatedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, DepartmentCreatedEvent) -> Any
...
class DepartmentDeletedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, DepartmentDeletedEvent) -> Any
        return self.handler(ctx, conf, event)
...
class DepartmentUpdatedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, DepartmentUpdatedEvent) -> Any
        return self.handler(ctx, conf, event)
...
class EmployeeTypeEnumActivedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, EmployeeTypeEnumActivedEvent) -> Any
        return self.handler(ctx, conf, event)
...
class EmployeeTypeEnumCreatedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, EmployeeTypeEnumCreatedEvent) -> Any
        return self.handler(ctx, conf, event)
...
class EmployeeTypeEnumDeactivatedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, EmployeeTypeEnumDeactivatedEvent) -> Any
        return self.handler(ctx, conf, event)
...
class EmployeeTypeEnumDeletedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, EmployeeTypeEnumDeletedEvent) -> Any
        return self.handler(ctx, conf, event)
...
class EmployeeTypeEnumUpdatedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, EmployeeTypeEnumUpdatedEvent) -> Any
        return self.handler(ctx, conf, event)
...
class ScopeUpdatedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, ScopeUpdatedEvent) -> Any
        return self.handler(ctx, conf, event)
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(
            conf, "contact.scope.updated_v3", handler.handle, clazz=ScopeUpdatedEvent
        )
...
class UserCreatedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, UserCreatedEvent) -> Any
        return self.handler(ctx, conf, event)
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(
            conf, "contact.user.created_v3", handler.handle, clazz=UserCreatedEvent
        )
...
class UserDeletedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, UserDeletedEvent) -> Any
        return self.handler(ctx, conf, event)
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(
            conf, "contact.user.deleted_v3", handler.handle, clazz=UserDeletedEvent
        )
...
class UserUpdatedEventHandler:
    ...
    def handle(
        self, ctx, conf, event
    ):  # type: (Context, Config, UserUpdatedEvent) -> Any
        return self.handler(ctx, conf, event)
    ...
    def set_callback(conf, callback):
        ...
        set_event_callback(
            conf, "contact.user.updated_v3", handler.handle, clazz=UserUpdatedEvent
        )

...
class DocsMeta:
    ...
    latest_modify_user = attr.ib(
        type=str, default=None, metadata={"json": "latest_modify_user"}
    )
    latest_modify_time = attr.ib(
        type=int, default=None, metadata={"json": "latest_modify_time"}
    )
...
class DocsApiMetaReqBody:
    request_docs = attr.ib(
        type=List[RequestDoc], default=None, metadata={"json": "request_docs"}
    )
...
class DocsApiMetaResult:
    docs_metas = attr.ib(
        type=List[DocsMeta], default=None, metadata={"json": "docs_metas"}
    )
...
class DocsApiSearchResult:
    docs_entities = attr.ib(
        type=List[DocsEntity], default=None, metadata={"json": "docs_entities"}
    )

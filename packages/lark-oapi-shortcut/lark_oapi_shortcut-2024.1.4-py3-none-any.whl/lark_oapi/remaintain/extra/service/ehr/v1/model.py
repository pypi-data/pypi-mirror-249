...
class SystemFields:
    ...
    work_location = attr.ib(
        type=WorkLocation, default=None, metadata={"json": "work_location"}
    )
    gender = attr.ib(type=int, default=None, metadata={"json": "gender"})
    birthday = attr.ib(type=str, default=None, metadata={"json": "birthday"})
    native_region = attr.ib(
        type=NativeRegion, default=None, metadata={"json": "native_region"}
    )
    ethnicity = attr.ib(type=int, default=None, metadata={"json": "ethnicity"})
    marital_status = attr.ib(
        type=int, default=None, metadata={"json": "marital_status"}
    )
    political_status = attr.ib(
        type=int, default=None, metadata={"json": "political_status"}
    )
    entered_workforce_date = attr.ib(
        type=str, default=None, metadata={"json": "entered_workforce_date"}
    )
    ...
    hukou_location = attr.ib(
        type=str, default=None, metadata={"json": "hukou_location"}
    )
    bank_account_number = attr.ib(
        type=str, default=None, metadata={"json": "bank_account_number"}
    )
    bank_name = attr.ib(type=str, default=None, metadata={"json": "bank_name"})
    social_security_account = attr.ib(
        type=str, default=None, metadata={"json": "social_security_account"}
    )
    provident_fund_account = attr.ib(
        type=str, default=None, metadata={"json": "provident_fund_account"}
    )
    ...
    probation_months = attr.ib(
        type=float, default=None, metadata={"json": "probation_months"}
    )
    conversion_date = attr.ib(
        type=str, default=None, metadata={"json": "conversion_date"}
    )
    application = attr.ib(type=int, default=None, metadata={"json": "application"})
    application_status = attr.ib(
        type=int, default=None, metadata={"json": "application_status"}
    )
    last_day = attr.ib(type=str, default=None, metadata={"json": "last_day"})
    departure_type = attr.ib(
        type=int, default=None, metadata={"json": "departure_type"}
    )
    departure_reason = attr.ib(
        type=int, default=None, metadata={"json": "departure_reason"}
    )
    departure_notes = attr.ib(
        type=str, default=None, metadata={"json": "departure_notes"}
    )
    contract_company = attr.ib(
        type=ContractCompany, default=None, metadata={"json": "contract_company"}
    )
    contract_type = attr.ib(type=int, default=None, metadata={"json": "contract_type"})
    contract_start_date = attr.ib(
        type=str, default=None, metadata={"json": "contract_start_date"}
    )
    contract_expiration_date = attr.ib(
        type=str, default=None, metadata={"json": "contract_expiration_date"}
    )
    contract_sign_times = attr.ib(
        type=int, default=None, metadata={"json": "contract_sign_times"}
    )
    personal_email = attr.ib(
        type=str, default=None, metadata={"json": "personal_email"}
    )
    family_address = attr.ib(
        type=str, default=None, metadata={"json": "family_address"}
    )
    ...
    highest_level_of_edu = attr.ib(
        type=Education, default=None, metadata={"json": "highest_level_of_edu"}
    )
    education = attr.ib(
        type=List[Education], default=None, metadata={"json": "education"}
    )
    former_work_exp = attr.ib(
        type=WorkExperience, default=None, metadata={"json": "former_work_exp"}
    )
    work_exp = attr.ib(
        type=List[WorkExperience], default=None, metadata={"json": "work_exp"}
    )
    id_photo_po_side = attr.ib(
        type=List[Attachment], default=None, metadata={"json": "id_photo_po_side"}
    )
    id_photo_em_side = attr.ib(
        type=List[Attachment], default=None, metadata={"json": "id_photo_em_side"}
    )
    id_photo = attr.ib(
        type=List[Attachment], default=None, metadata={"json": "id_photo"}
    )
    diploma_photo = attr.ib(
        type=List[Attachment], default=None, metadata={"json": "diploma_photo"}
    )
    graduation_cert = attr.ib(
        type=List[Attachment], default=None, metadata={"json": "graduation_cert"}
    )
    cert_of_merit = attr.ib(
        type=List[Attachment], default=None, metadata={"json": "cert_of_merit"}
    )
    offboarding_file = attr.ib(
        type=List[Attachment], default=None, metadata={"json": "offboarding_file"}
    )
    cancel_onboarding_reason = attr.ib(
        type=int, default=None, metadata={"json": "cancel_onboarding_reason"}
    )
    cancel_onboarding_notes = attr.ib(
        type=str, default=None, metadata={"json": "cancel_onboarding_notes"}
    )
    employee_form_status = attr.ib(
        type=int, default=None, metadata={"json": "employee_form_status"}
    )
...
class Employee:
    user_id = attr.ib(type=str, default=None, metadata={"json": "user_id"})
    system_fields = attr.ib(
        type=SystemFields, default=None, metadata={"json": "system_fields"}
    )
    custom_fields = attr.ib(
        type=List[CustomFields], default=None, metadata={"json": "custom_fields"}
    )

...
pub struct StoreServicesCoreADIProxy {
    ...
    sap_init: sysv64_type!(fn(out_sap_context_id: *mut u32, id: *const u8) -> i32),
...
impl StoreServicesCoreADIProxy {
    ...
    fn set_fireplay_path(&mut self, provisioning_path: String, device: Vec<u8>) -> PyResult<FairPlaySession> {
        let prov_path = PathBuf::from(provisioning_path);

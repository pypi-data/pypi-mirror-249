...
class MatchSetWhitelistReporterObservedSequenceCounterSeriesResults:
    ambiguous_ignored_umi_noncollapsed_alleleseries : Optional[DefaultDict[Tuple[str, Optional[str], Optional[str]], pd.Series]] = None
    ambiguous_ignored_umi_collapsed_alleleseries : Optional[DefaultDict[Tuple[str, Optional[str], Optional[str]], pd.Series]] = None
    ambiguous_ignored_alleleseries : Optional[DefaultDict[Tuple[str, Optional[str], Optional[str]], pd.Series]] = None

    ambiguous_accepted_umi_noncollapsed_alleleseries : Optional[DefaultDict[Tuple[str, Optional[str], Optional[str]], pd.Series]] = None
    ambiguous_accepted_umi_collapsed_alleleseries : Optional[DefaultDict[Tuple[str, Optional[str], Optional[str]], pd.Series]] = None
    ambiguous_accepted_alleleseries : Optional[DefaultDict[Tuple[str, Optional[str], Optional[str]], pd.Series]] = None

    ambiguous_spread_umi_noncollapsed_alleleseries : Optional[DefaultDict[Tuple[str, Optional[str], Optional[str]], pd.Series]] = None
    ambiguous_spread_umi_collapsed_alleleseries : Optional[DefaultDict[Tuple[str, Optional[str], Optional[str]], pd.Series]] = None
    ambiguous_spread_alleleseries : Optional[DefaultDict[Tuple[str, Optional[str], Optional[str]], pd.Series]] = None

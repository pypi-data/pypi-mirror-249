...
from test_tele.pyrogram.pixiv import inline_pixiv, get_px_file, upload_px_batch
...
from test_tele.pyrogram.furry import inline_furry, get_fur_file, upload_fur_batch

...
class Profiler(object):
    ...
    def save_virtual_data(self, data, filePath):
        r"""
        Saves the 'ProfileBatch' data collected, 'Parameter' s, and 'ProfilerInfo'
        into a .mraw file to be used to open a 'VirtualProfiler'.

        :type data: :py:class:`ProfileBatch`
        :param data: 'ProfileBatch' collected to be saved.
        :type filePath: string
        :param filePath: File path to save the .mraw file to
        ...
        """
        return _profiler.Profiler_save_virtual_data(self, data, filePath)
    ...
    def retrieve_batch_data(self, batch, timeoutMs=4000):
        r"""
        Retrieves a batch of the profiles in scan mode. There are two ways to retrieve profile
        data, by polling or callback. This function is only used for polling.
        The profile count in batch is not fixed, it is related to the scan rate and the rate of this
        function is called.
    ...
    def start_acquisition(self):
        r"""
        Enters the laser profiler into the data acquisition status, where it can accept
        trigger signals. This method must be called before 'triggerSoftware'.
        :rtype: :py:class:`ErrorStatus`
        :return: 
             'ErrorStatus.MMIND_STATUS_SUCCESS' Success.
    ...
    def stop_acquisition(self):
        r"""
        Exits the laser profiler from the data acquisition status, and then it can not accept
        trigger signals. If callback function is being executed when this function is called, this
        function will block until callback function is finished.
        :rtype: :py:class:`ErrorStatus`
        :return: 
             'ErrorStatus.MMIND_STATUS_SUCCESS' Success.
...
class AnalogGain(object):
    ...
    Value_Gain_1_0 = _profiler.AnalogGain_Value_Gain_1_0
    
    Value_Gain_1_3 = _profiler.AnalogGain_Value_Gain_1_3
    
    Value_Gain_1_9 = _profiler.AnalogGain_Value_Gain_1_9
    
    Value_Gain_2_8 = _profiler.AnalogGain_Value_Gain_2_8
    
    Value_Gain_5_5 = _profiler.AnalogGain_Value_Gain_5_5

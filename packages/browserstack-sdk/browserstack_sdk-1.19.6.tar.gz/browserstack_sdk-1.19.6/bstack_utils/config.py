...
conf = {
    bstack1lll11l_opy_ (u"ࠨࡣࡳࡴࡤࡧࡵࡵࡱࡰࡥࡹ࡫ࠧປ"): False,
    bstack1lll11l_opy_ (u"ࠩࡥࡷࡹࡧࡣ࡬ࡡࡶࡩࡸࡹࡩࡰࡰࠪຜ"): True,
    bstack1lll11l_opy_ (u"ࠪࡷࡰ࡯ࡰࡠࡵࡨࡷࡸ࡯࡯࡯ࡡࡶࡸࡦࡺࡵࡴࠩຝ"): False
}
class Config(object):
    instance = None
    def __init__(self):
    ...
    def bstack11l1l1ll_opy_(self, property_name, bstack11ll1l1ll1_opy_):
        self._11ll1l1l1l_opy_[property_name] = bstack11ll1l1ll1_opy_
    def bstack1lllll11ll_opy_(self, val):
        self._11ll1l1l1l_opy_[bstack1lll11l_opy_ (u"ࠫࡸࡱࡩࡱࡡࡶࡩࡸࡹࡩࡰࡰࡢࡷࡹࡧࡴࡶࡵࠪພ")] = bool(val)
    def bstack1l11111111_opy_(self):
        return self._11ll1l1l1l_opy_.get(bstack1lll11l_opy_ (u"ࠬࡹ࡫ࡪࡲࡢࡷࡪࡹࡳࡪࡱࡱࡣࡸࡺࡡࡵࡷࡶࠫຟ"), False)
...
class FilterCog(commands.Cog):
    ...
    async def filter_options(self, **kwargs):
        ...
        column_types = {
            ...
            'normalized_theta_vega_ratio': ('theta_vega_ratio', 'float'),
            'normalized_theta_vega_ratio_min': ('theta_vega_ratio', 'float'),
            'normalized_theta_vega_ratio_max': ('theta_vega_ratio', 'float'),
        ...
        query = "SELECT ticker, strike, call_put, expiry, theta FROM public.opts WHERE open_interest > 0"

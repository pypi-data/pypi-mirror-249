...
from list_sets.ticker_lists import all_tickers, most_active_tickers
import pandas as pd

# Setting environment variables
os.environ['DB_HOST'] = 'localhost'
os.environ['DB_PASSWORD'] = 'fud'
os.environ['DB_NAME'] = 'opts'
...
db_config = {
    ...
    "database": os.environ.get('opts', 'opts')
}


opts = PolygonOptions(user='postgres', database='opts')

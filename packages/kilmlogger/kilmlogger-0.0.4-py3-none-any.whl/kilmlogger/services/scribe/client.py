...
from kilmlogger.services.scribe.grpc.scribelog_pb2 import ListOfEntryRequest, LogEntryRequest, LogEntry
...
class ScribeClient(object):
    ...
    def build_grpc_stub(host: str, port: str) -> ScribeLogServiceStub:
        channel: grpc.Channel = grpc.insecure_channel(f"{host}:{port}")

...
class ScribeLogService(object):
    ...
    def sendLog(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.vng.zlb.scribelog.grpc.lib.ScribeLogService/sendLog',
    ...
    def sendMultiLog(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.vng.zlb.scribelog.grpc.lib.ScribeLogService/sendMultiLog',
    ...
    def sendActionLog(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.vng.zlb.scribelog.grpc.lib.ScribeLogService/sendActionLog',
    ...
    @staticmethod
    def sendMultiActionLog(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.vng.zlb.scribelog.grpc.lib.ScribeLogService/sendMultiActionLog',
    ...
    def sendMultiLogV2(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.vng.zlb.scribelog.grpc.lib.ScribeLogService/sendMultiLogV2',
            scribelog__pb2.ListOfEntryRequest.SerializeToString,
            scribelog__pb2.LogEntryResult.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def pingPong(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.vng.zlb.scribelog.grpc.lib.ScribeLogService/pingPong',

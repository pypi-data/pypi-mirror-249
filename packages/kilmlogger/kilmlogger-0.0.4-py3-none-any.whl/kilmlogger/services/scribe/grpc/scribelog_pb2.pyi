...
class ListOfEntryRequest(_message.Message):
    ...
    def __init__(self, logEntryRequest: _Optional[_Iterable[_Union[LogEntryRequest, _Mapping]]] = ...) -> None: ...
...
class ListOfActionLogRequest(_message.Message):
    ...
    def __init__(self, actionLogRequest: _Optional[_Iterable[_Union[ActionLogRequest, _Mapping]]] = ...) -> None: ...
...
class ActionLogRequest(_message.Message):
    ...
    timestamp: int
    json_param: str
    def __init__(self, timestamp: _Optional[int] = ..., json_param: _Optional[str] = ...) -> None: ...
...
class LogEntryRequest(_message.Message):
    ...
    app_prop: str
    log_entry: LogEntry
    def __init__(self, timestamp: _Optional[int] = ..., category: _Optional[str] = ..., app_name: _Optional[str] = ..., app_prop: _Optional[str] = ..., log_entry: _Optional[_Union[LogEntry, _Mapping]] = ...) -> None: ...
...
class LogEntryResult(_message.Message):
    ...
    error: int
    error_message: str
    def __init__(self, error: _Optional[int] = ..., error_message: _Optional[str] = ...) -> None: ...

class LogEntry(_message.Message):
    __slots__ = ("ip", "src_id", "des_id", "command", "sub_command", "result", "start_time", "execute_time", "json_param", "json_ext_param", "client_type", "client_version", "type", "dp_log", "dp_cate")
    ...
    dp_log: str
    dp_cate: str
    def __init__(self, ip: _Optional[str] = ..., src_id: _Optional[int] = ..., des_id: _Optional[int] = ..., command: _Optional[int] = ..., sub_command: _Optional[int] = ..., result: _Optional[int] = ..., start_time: _Optional[int] = ..., execute_time: _Optional[int] = ..., json_param: _Optional[str] = ..., json_ext_param: _Optional[str] = ..., client_type: _Optional[int] = ..., client_version: _Optional[int] = ..., type: _Optional[int] = ..., dp_log: _Optional[str] = ..., dp_cate: _Optional[str] = ...) -> None: ...

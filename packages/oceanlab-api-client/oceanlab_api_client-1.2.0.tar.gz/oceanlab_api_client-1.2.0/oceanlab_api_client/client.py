...
class Client:
    ...
    _base_url: str = "https://api.oceanlab.sintef.no/json"
...
class AuthenticatedClient:
    ...
    def login_sintef(self) -> None:
        """Get access token from SINTEF AD."""
        sintef_ad_client_id = (
            "5f2d3881-0a24-41d0-bd64-031bc77c63d4"  # Application "api.oceanlab.sintef.no", registered in SINTEF Tenant
        )
    ...
    def login_public(self) -> None:
        ...
        if self._auth["id_token_claims"]["idp"] == "google.com":
            ...
            raise AuthenticationFailed(
                ...
                `login_public()` is currently not supported. \n\nSelect 'Google' \

...
def vfi_plot(cl=Solow_simple,max_iter=1e2,s_grid=[],initial_guess=[],optimal=0,tol=0,policy=None,policy_iterations=0,ax_pol=0,plot=1):
  if not list(s_grid):
      s_grid=cl.s_grid
...
class Solow_simple:
    ...
    def __init__(self,
                 ...
                 δ=1e-1,
                 A=1,
                 mps=.5, alpha=.3,delta=.2, s_min=0, s_max = 9):

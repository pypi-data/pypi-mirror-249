...
class analyzer:
    ...
    def _get_const(self):
        ...
        l_var = [ self._d_cns[par.name][1]**2 for par in l_par ] 

        return zfit.constraint.GaussianConstraint(l_par, l_val, l_var)
    #---------------------------------
    ...
    def _run_minimization(self, nfit, kind=None):
        ...
        self._reset_pdf()
        zut.print_pdf(self._pdf, d_const=self._d_cns)
    ...
    def fit(self, nfit=100):
        ...
        self._plot_pulls(df_val, df_err)
    ...
    def _get_fit_df(self, l_res):
        ...
        return df_val, df_err
    #---------------------------------
    def _plot_pulls(self, df_val, df_err):
        if self._out_dir is None:
            return

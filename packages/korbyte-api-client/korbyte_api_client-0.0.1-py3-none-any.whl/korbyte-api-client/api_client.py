...
import korbyte-api-client.models
from korbyte-api-client import rest
from korbyte-api-client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(korbyte-api-client.models, klass)

...
def create_partition_table_shamsi(df , table_name , connection , range_key , primary_key_list):
...
def create_partition_table_miladi(df , table_name , connection , range_key , primary_key_list):

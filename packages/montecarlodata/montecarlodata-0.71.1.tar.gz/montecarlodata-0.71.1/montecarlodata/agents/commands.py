...
@agents.command(name="get-gcp-logs", help="Returns the logs for a remote GCP Agent.")
@click.pass_obj
...
@agents.command(name="get-aws-logs", help="Returns the logs for a remote AWS Agent.")
@click.pass_obj
@add_common_options(_AGENT_LOGS_COMMON_OPTIONS)
@click.option(
    "--start-time",

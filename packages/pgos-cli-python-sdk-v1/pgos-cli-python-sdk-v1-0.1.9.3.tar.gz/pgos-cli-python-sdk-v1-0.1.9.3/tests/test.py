...
# import form local code
# from pgos_cli_python_sdk_v1.pgos_cli_client import PgosCliClient
...
pgos_cli_client.SetSecretKey('11NL-0P2R-IVUI-O6SX-AOBA')
pgos_cli_client.SetTitleRegion('d_5_812179_dev')

# pgos_cli_client.SetSecretKey('74E4-V6HX-759R-21DF-HVE0')
# pgos_cli_client.SetTitleRegion('cnsh_5_934_test')

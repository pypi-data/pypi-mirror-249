def insert_lines(file_path, action, *args,insert_string):
    ...
    if action == "insert_before" and len(args) == 1 and isinstance(args[0], int):
        ...
        print(f"the line {insert_string} is inserted before {args[0]}")
        msg = f"the line {insert_string} is inserted before {args[0]}"
        return True, msg
        ...
        print(f"the line {insert_string} inserted after {args[0]}")
        msg = f"the line {insert_string} inserted after {args[0]}"
        return True, msg

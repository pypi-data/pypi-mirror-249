...
## What's Changed
* Fixed exception raised when creating existing Logs and data folder by @yesseruser in https://github.com/Yesser-Studios/ypkgupgr/pull/15


**Full Changelog**: https://github.com/Yesser-Studios/ypkgupgr/compare/1.10.1...1.10.2

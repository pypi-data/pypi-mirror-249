...
from content_security_policy import values
...
class DirectivesComplete(TestCase):
    ...
    def test_sankdbox(self):
        test = directives.Sandbox(values.SandboxToken.allow_modals)
        test = directives.ReportUri(values.UriReference(""))

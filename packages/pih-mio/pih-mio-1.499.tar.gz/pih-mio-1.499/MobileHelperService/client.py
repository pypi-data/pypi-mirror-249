...
from MobileHelperService.const import MOBILE_HELPER_USER_SETTINGS_NAME, MODULE_NAME, VERSION, ADMIN_ALIAS
from pih.tools import ne, e, n
...
class MOBILE_HELPER:
    ...
    def start(host: bool, admin: bool) -> bool:
        print(A.U.install_module(A.root.NAME, A.V.value, True, host))
        print(A.U.install_module(MODULE_NAME, VERSION, True, host))
        A.R_SSH.execute()

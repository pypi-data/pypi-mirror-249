...
def setup(image:Image):
    ...
    location_life = pyautogui.locate(ar, image, confidence=.8)
    if location_life != None:
        ...
        global dimensions
        dimensions = (inicio_x, inicio_y, final_x, final_y), (inicio_x, inicio_y+RANGE_MANA_POSITION, final_x, final_y+RANGE_MANA_POSITION)
    else:
        return None
import vispunk_motion.comfy.supported_models
...
def model_config_from_unet_config(unet_config):
    for model_config in vispunk_motion.comfy.supported_models.models:
...
def model_config_from_unet(state_dict, unet_key_prefix, dtype, use_base_if_no_match=False):
    ...
    if model_config is None and use_base_if_no_match:
        return vispunk_motion.comfy.supported_models_base.BASE(unet_config)
    else:
        return model_config

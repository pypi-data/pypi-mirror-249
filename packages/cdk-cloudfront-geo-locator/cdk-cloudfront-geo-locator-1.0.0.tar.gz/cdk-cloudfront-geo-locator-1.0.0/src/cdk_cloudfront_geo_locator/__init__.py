...
class CloudfrontGeoLocator(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: -
        :param id: -
        :param cloudfront_cache_policy_name: A unique name to identify the cloudfront cache policy. Default: - CloudfrontGeoLocatorCachePolicy
        :param cloudfront_origin_request_policy_name: A unique name to identify the cloudfront origin request policy. Default: - CloudfrontGeoLocatorOriginRequestPolicy
        :param cloudfront_price_class: The price class for the CloudFront distribution. Default: - PRICE_CLASS_100
        :param custom_domain_certificate_arn: The ARN of the certificate. Default: - undefined
        :param custom_domain_name: The domain name for the CloudFront distribution. Default: - undefined
        :param lambda_function_name: A unique name to identify the lambda function. Default: - cloudfront-geo-locator
        :param s3_bucket_name: A unique name to identify the s3 bucket. Default: - cloudfront-geo-locator-origin

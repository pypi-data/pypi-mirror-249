...
class RolloutWorker:
    ...
    def __init__(
        ...
        self._previous_sensor_readings: Optional[
    ...
    async def _handle_agent_update(self, request: AgentUpdateRequest):
        ...
        setpoints, data_for_brain = self._try_propose_actions(
    ...
    def _try_propose_actions(
        ...
        try:
            data = self._muscle.propose_actions(sensors, actuators)

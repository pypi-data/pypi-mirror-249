...
def scrape(
    ...
    with_json: Optional[bool] = False,
    with_geojson: Optional[bool] = False,
    ...
    Args:
        ...
        json_output (str, optional): The file subpath to save the scraped posts in JSON format. Defaults to None.
    ...
    if with_json:
        dump_posts(username, posts, os.path.join(target, f"{username}.json"))

    if with_map:
        map_output = f"{username}.html"

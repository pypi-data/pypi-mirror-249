...
def scrape(
    ...
    json_output: Annotated[
        ...
        typer.Option(
            "--json",
            "-j",
            help="whether to dump the posts to a JSON file or not. if a file name is provided, it will be used as the output file name. Defaults to {username}.json",
        ),
    ] = None,
    geojson_output: Annotated[
        ...
        typer.Option(
            "--geojson",
            "-g",
            help="whether to dump the posts to a GeoJSON file or not. If map is enabled, this will be enabled by default. If a file name is provided, it will be used as the output file name. Defaults to {username}.geojson",
        ),
    ] = None,
    map_output: Annotated[
        ...
        typer.Option(
            "--map",
            "-m",
            help="whether to create a map with the posts or not. It will enable GeoJSON output by default. If a file name is provided, it will be used as the output file name. Defaults to {username}.html",
        ),
    ] = None,
    target: Annotated[
        str,

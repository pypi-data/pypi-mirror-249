...
from instagraper.utils import dump_posts, are_same_directory
...
def scrape(
    ...
    Args:
        ...
        json_output (str, optional): The file name to save the scraped posts in JSON format. Defaults to None.
        geojson_output (str, optional): The file name to save the scraped posts in GeoJSON format. Defaults to None.
        map_output (str, optional): The file name to save the generated map. Defaults to None.
        with_images (bool, optional): Flag indicating whether to download and save images. Defaults to False.
        target (str, optional): The target directory to save the scraped posts and generated files. Defaults to None.

...
#     def calculate_hailstone_sequence(self, starting_number=None):
...
#         return len(self.sequence) - 1  # Excluding the initial number
...
class HailstoneCalculator:
    ...
    def calculate_hailstone_sequence(self, starting_number: int = None) -> None:
        """
        Calculates the hailstone sequence for the specified starting number.

        Parameters:
        - starting_number (int): The new starting number. If not provided, uses the initial starting number.

...
class PlausibilityFrame(JSONSerializableStructure):
    ...
    @classmethod
    def from_str_dict(cls, str_dict: Dict, **kwargs: Any) -> PlausibilityFrame:
        ...
        instance = cls(domain=domain, state_to_appearance=state_to_appearance, force_s4=kwargs.get("force_s4", False))

  ...
  "parameters": {
    ...
    "required": [
      "time"
                        ...
                        "description": "All content is in Czech: předpověď počasí na dnes a zítra",
                        "parameters": {
                            "type": "object",
                            "properties": {
                                "time": {"type": "string", "description": "two options only: dnes | zítra"}
                            },
#### return json
...
def get_chmi(time, url="https://www.chmi.cz/predpovedi/predpovedi-pocasi/ceska-republika/predpoved-na-dnesek-resp-zitra"):
    ...
    if time not in ["dnes","zítra","zitra"]:
            ...
            if current_header:
                ...
                if 'textik1' in p['class']:
                    ...
                    if line.find("Počasí")>=0:
                        ...
                        print(fg.lightyellow, current_sub, fg.magenta, "Počasí", fg.default)

...
def build_extend_infos():
    ...
    # 电子邮箱
    extend_infos["email"] = "changliang.wang@huifu.com"
    # 卡的借贷类型
...
class TestV2QuickbuckleApplyRequestDemo(unittest.TestCase):
    ...
    def test_request(self):
        ...
        # 接口请求对象
        request = dg_sdk.V2QuickbuckleApplyRequest()
        request.req_date = ""
        request.req_seq_id = ""
        ...
        request.cert_begin_date = "20210806"
        request.cert_end_date = "20410806"

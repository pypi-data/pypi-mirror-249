...
If you are a contributor and want an [editable install](https://peps.python.org/pep-0660/), then:

1. Clone the tonydbc repo from GitHub
2. Navigate to the tonydbc root directory and type `python -m pip install -e .`

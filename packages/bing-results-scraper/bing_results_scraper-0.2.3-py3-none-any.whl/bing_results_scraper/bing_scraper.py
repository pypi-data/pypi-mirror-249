...
class BingScraper():
    ...
    def __init__(self,headers=headers):
        ...
        Initializes a BingScraper object.
            ...
            Args:
                headers: Optional dictionary of headers to use for HTTP requests. If not
                    provided, a default set of headers will be used.
        """
...
class AsyncBingScraper:
    ...
    def __init__(self, headers=headers, max_retries=3):
        """
    ...
    def get_results(self, queries):
        ...
        Returns:
            A list of dictionaries, where each dictionary contains the search results
            and status information for a corresponding query. Each dictionary contains
            the following keys:

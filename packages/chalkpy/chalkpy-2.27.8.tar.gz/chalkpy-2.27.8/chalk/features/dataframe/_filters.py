...
class PyArrowParsedExpr(ParsedExpr):
    ...
    def __eq__(self, __value: object, /) -> Self:
        ...
        return type(self)(
            pc.equal(self.col, __value.col),  # type: ignore
            self._get_equivalent_table_reference(__value),
        )
    ...
    def __ne__(self, __value: object, /) -> Self:
        if not isinstance(__value, PyArrowParsedExpr):
            raise TypeError("A PyArrowParsedExpr can only be compared to a PyArrowParsedExpr")
        return type(self)(
            pc.not_equal(self.col, __value.col),  # type: ignore
            self._get_equivalent_table_reference(__value),
        )
    ...
    def __gt__(self, __value: object, /) -> Self:
        if not isinstance(__value, PyArrowParsedExpr):
            raise TypeError("A PyArrowParsedExpr can only be compared to a PyArrowParsedExpr")
        return type(self)(
            pc.greater(self.col, __value.col),  # type: ignore
            self._get_equivalent_table_reference(__value),
        )
    ...
    def __lt__(self, __value: object, /) -> Self:
        if not isinstance(__value, PyArrowParsedExpr):
            raise TypeError("A PyArrowParsedExpr can only be compared to a PyArrowParsedExpr")
        return type(self)(
            pc.less(self.col, __value.col),  # type: ignore
            self._get_equivalent_table_reference(__value),
        )
    ...
    def __le__(self, __value: object, /) -> Self:
        if not isinstance(__value, PyArrowParsedExpr):
            raise TypeError("A PyArrowParsedExpr can only be compared to a PyArrowParsedExpr")
        return type(self)(
            pc.less_equal(self.col, __value.col),  # type: ignore
            self._get_equivalent_table_reference(__value),
        )
    ...
    def __ge__(self, __value: object, /) -> Self:
        if not isinstance(__value, PyArrowParsedExpr):
            raise TypeError("A PyArrowParsedExpr can only be compared to a PyArrowParsedExpr")
        return type(self)(
            pc.greater_equal(self.col, __value.col),  # type: ignore
            self._get_equivalent_table_reference(__value),
        )

    def __invert__(self) -> Self:
        return type(self)(
            pc.invert(self.col),  # type: ignore
            self.table,
        )
    ...
    def __add__(self, __value: object, /) -> Self:
        if not isinstance(__value, PyArrowParsedExpr):
            raise TypeError("A PyArrowParsedExpr can only be compared to a PyArrowParsedExpr")
        return type(self)(
            pc.add_checked(self.col, __value.col),  # type: ignore
            self._get_equivalent_table_reference(__value),
        )
    ...
    def __sub__(self, __value: object, /) -> Self:
        if not isinstance(__value, PyArrowParsedExpr):
            raise TypeError("A PyArrowParsedExpr can only be compared to a PyArrowParsedExpr")
        return type(self)(
            pc.subtract_checked(self.col, __value.col),  # type: ignore
            self._get_equivalent_table_reference(__value),
        )
    ...
    def __and__(self, __value: object, /) -> Self:
        if not isinstance(__value, PyArrowParsedExpr):
            raise TypeError("A PyArrowParsedExpr can only be compared to a PyArrowParsedExpr")
        return type(self)(
            pc.and_(self.col, __value.col),  # type: ignore
            self._get_equivalent_table_reference(__value),
        )
    ...
    def __or__(self, __value: object, /) -> Self:
        if not isinstance(__value, PyArrowParsedExpr):
            raise TypeError("A PyArrowParsedExpr can only be compared to a PyArrowParsedExpr")
        return type(self)(pc.or_(self.col, __value.col), self._get_equivalent_table_reference(__value))  # type: ignore
...
class PyArrowFilterConverter(FilterConverter[ParsedExpr]):
    ...
    def if_else(self, cond: ParsedExpr, true_case: ParsedExpr, false_case: ParsedExpr):
        ...
        return PyArrowParsedExpr(
            pc.if_else(cond.col, true_case.col, false_case.col),  # type: ignore
            self._table,
        )

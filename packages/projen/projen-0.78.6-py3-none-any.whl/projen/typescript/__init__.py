...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={
        "tranform_pattern": "tranformPattern",
...
class TsJestOptions:
    def __init__(
        self,
        *,
        tranform_pattern: typing.Optional[builtins.str] = None,
        transform_options: typing.Optional[typing.Union["TsJestTransformOptions", typing.Dict[builtins.str, typing.Any]]] = None,
    ) -> None:
        '''
        :param tranform_pattern: (experimental) Which files should ts-jest act upon. Default: "^.+\\.[t]sx?$"
        ...
        if __debug__:
            ...
            check_type(argname="argument tranform_pattern", value=tranform_pattern, expected_type=type_hints["tranform_pattern"])
            check_type(argname="argument transform_options", value=transform_options, expected_type=type_hints["transform_options"])
        self._values: typing.Dict[builtins.str, typing.Any] = {}
        if tranform_pattern is not None:
            self._values["tranform_pattern"] = tranform_pattern
        if transform_options is not None:
            self._values["transform_options"] = transform_options

    @builtins.property
    def tranform_pattern(self) -> typing.Optional[builtins.str]:
        ...
        :stability: experimental
        '''
        result = self._values.get("tranform_pattern")
        return typing.cast(typing.Optional[builtins.str], result)

...
@jsii.data_type(
    jsii_type="projen.github.CommonWorkflowStepOptions",
    jsii_struct_bases=[],
    name_mapping={"id": "id", "if_": "if", "name": "name"},
)
class CommonWorkflowStepOptions:
    def __init__(
        self,
        *,
        ...
        '''
        :param id: (experimental) A unique identifier for the step.
        :param if_: (experimental) A condition to determine whether to run this step.
        :param name: (experimental) The name of the step.

        :stability: experimental
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7efa221b8e1a933e26196c0b56cb73deeba4dd36be38e19140d9d17463788f37)
    ...
    def if_(self) -> typing.Optional[builtins.str]:
        '''(experimental) A condition to determine whether to run this step.
    ...
    def __repr__(self) -> str:
        return "CommonWorkflowStepOptions(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
@jsii.data_type(
    ...
    jsii_struct_bases=[CommonWorkflowStepOptions],
    name_mapping={
        "id": "id",
        "if_": "if",
        "name": "name",
...
class SetupGitIdentityOptions(CommonWorkflowStepOptions):
    def __init__(
        self,
        *,
        id: typing.Optional[builtins.str] = None,
...
class WorkflowSteps(metaclass=jsii.JSIIMeta, jsii_type="projen.github.WorkflowSteps"):
    ...
    def checkout(
        ...
        *,
        ...
        :stability: experimental
        '''
        options = CheckoutOptions(with_=with_, id=id, if_=if_, name=name)
    ...
    def setup_git_identity(
        ...
        *,
        ...
        options = SetupGitIdentityOptions(
            git_identity=git_identity, id=id, if_=if_, name=name
        )
...
@jsii.data_type(
    ...
    jsii_struct_bases=[CommonWorkflowStepOptions],
    name_mapping={"id": "id", "if_": "if", "name": "name", "with_": "with"},
)
class CheckoutOptions(CommonWorkflowStepOptions):
    def __init__(
        self,
        *,
        id: typing.Optional[builtins.str] = None,
...
def _typecheckingstub__7efa221b8e1a933e26196c0b56cb73deeba4dd36be38e19140d9d17463788f37(
    *,
    id: typing.Optional[builtins.str] = None,
    if_: typing.Optional[builtins.str] = None,
    name: typing.Optional[builtins.str] = None,

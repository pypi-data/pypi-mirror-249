...
class BitfountHub:
    ...
    def get_model(
        ...
        # TODO: [BIT-3528] Remove below 2 lines as part of the ticket
        suffix = ".py"
        file_path = Path(self.user_storage_path / "models" / model_name).with_suffix(
            suffix
        )
        model_file = self._write_model_code_to_file(
            model_code, self.user_storage_path / "models", model_name, suffix
        )

...
from .compose_spec import ComposeConfig
import json
...
class CLI(KoiledModel):
    """A CLI object that represents the docker-compose CLI. This is a
    pydantic model that can be used to build the docker-compose CLI
    ...
    async def ainspect_config(self) -> ComposeConfig:

...
class ItemDomainCableDesignAllOf(object):
    ...
    def __init__(self, is_housed=None, assigned_item=None, catalog_item=None, inventory_item=None, technical_system_list=None, alternate_name=None, local_vars_configuration=None):  # noqa: E501

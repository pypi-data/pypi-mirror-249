...
class MillipedeModelResultVisualizationExperimentalGroup:
    ...
    '''
    def __generate_millipede_heatmap_input(self, millipede_model_score_df: pd.DataFrame) -> Tuple[np.ndarray, np.ndarray, np.ndarray, np.ndarray]:
    ...
    def __plot_millipede_model_wrapper(self, millipede_model_score_df: pd.DataFrame, 
        ...
        coef_flatten, pip_flatten, xlabel_flatten, ylabel_flatten = self.__generate_millipede_heatmap_input(millipede_model_score_df)

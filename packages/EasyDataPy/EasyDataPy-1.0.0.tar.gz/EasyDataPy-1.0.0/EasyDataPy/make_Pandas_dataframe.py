...
def make_Pandas_dataframe(Series_ID, api_key, Start_date, End_date, format="csv"):
    """
    Download time-series data from the EasyData platform of the State Bank of Pakistan.
    ...
    -------
    pd.DataFrame
        A pandas DataFrame containing the downloaded data. The output is a object named dataFrame.

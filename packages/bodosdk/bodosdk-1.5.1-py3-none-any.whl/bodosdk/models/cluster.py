...
class ClusterResponse(CamelCaseBase):
    ...
    # TODO: Have also information about autoscaling_identifier/ last_asg_activity_id
    #  either autoscaling_identifier or asg_metadata should be removed
    asg_metadata: Optional[object] = Field(None, alias="asgMetadata")
    auto_az: Optional[bool] = Field(True, alias="autoAZ")
    use_spot_instance: Optional[bool] = Field(False, alias="useSpotInstance")
    # TODO: This data is not needed
    workspace: Any
    # TODO: Instance role is missing
    # TODO: Availability Zone is missing

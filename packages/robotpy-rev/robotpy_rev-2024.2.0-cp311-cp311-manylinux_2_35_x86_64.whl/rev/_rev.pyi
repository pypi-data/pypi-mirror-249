...
class CANSparkBase(CANSparkLowLevel):
    ...
    class SparkModel:
        ...
        Members:
          ...
          kUnknown
        """
        __members__: typing.ClassVar[dict[str, CANSparkBase.SparkModel]]  # value = {'kSparkMax': <SparkModel.kSparkMax: 0>, 'kSparkFlex': <SparkModel.kSparkFlex: 1>, 'kUnknown': <SparkModel.kUnknown: 255>}
        kSparkFlex: typing.ClassVar[CANSparkBase.SparkModel]  # value = <SparkModel.kSparkFlex: 1>
        kSparkMax: typing.ClassVar[CANSparkBase.SparkModel]  # value = <SparkModel.kSparkMax: 0>
        kUnknown: typing.ClassVar[CANSparkBase.SparkModel]  # value = <SparkModel.kUnknown: 255>
        def __eq__(self, other: typing.Any) -> bool:
            ...
        def __getstate__(self) -> int:
            ...
    ...
    def getEncoder(self, encoderType: SparkRelativeEncoder.Type = ..., countsPerRev: int = 42) -> SparkRelativeEncoder:
        ...
        """
    @typing.overload
    def getEncoder(self, encoderType: SparkMaxRelativeEncoder.Type = ..., countsPerRev: int = 42) -> SparkRelativeEncoder:
        """
        Returns an object for interfacing with the encoder connected to the
        encoder pins or front port of the SPARK MAX.
...
class CANSparkLowLevel(wpilib.interfaces._interfaces.MotorController):
    ...
    kAPIVersion: typing.ClassVar[int] = 132645376
    @staticmethod

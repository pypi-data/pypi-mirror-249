...
class PresentationFileWriter(object):
    ...
    def WriteFile(self, fileName: "std::string const &", author: "std::string const &", description: "std::string const &", buildNumber: "uint32_t const", narrationProjects: "std::vector< PresentationFile::NarrationProject,std::allocator< PresentationFile::NarrationProject > > const &", supplementaryFiles: "std::vector< PresentationFile::SupplementaryFile,std::allocator< PresentationFile::SupplementaryFile > > const &", presentationOrder: "std::vector< PresentationFile::PresentationItemType,std::allocator< PresentationFile::PresentationItemType > > const &", narrations: "std::vector< PresentationFile::Narration,std::allocator< PresentationFile::Narration > > const &", learningModules: "std::vector< LearningModule,std::allocator< LearningModule > > const") -> "void":

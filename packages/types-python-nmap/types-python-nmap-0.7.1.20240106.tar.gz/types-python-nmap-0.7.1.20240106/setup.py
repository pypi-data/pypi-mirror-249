...
type stub package for the [`python-nmap`](https://bitbucket.org/xael/python-nmap) package.
...
This version of `types-python-nmap` aims to provide accurate annotations
for `python-nmap==0.7.*`.

...
# Remove this wrapper once https://github.com/pydantic/pydantic/issues/8245 is fixed.
def validate_call(function: Callable[_P, _R], /) -> Callable[_P, _R]:
    ...
    validated_function = _validate_call(function)

    @wraps(function)
    def wrapper(*args: _P.args, **kwargs: _P.kwargs) -> _R:
        return validated_function(*args, **kwargs)

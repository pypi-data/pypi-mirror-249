...
from .udf import UDFBase, UDFClassWrapper, UDFFactory, UDFResult, UDFType
...
def adjust_outputs(data_storage, rows: UDFResult, udf: UDFBase) -> None:
    """
...
def process_udf_outputs(
    ...
    udf_table: "Table",
    udf_results: Iterator[UDFResult],
    udf: UDFBase,
    ...
    for udf_output in udf_results:
        if not udf_output:
            continue
        adjust_outputs(db_adapter, udf_output, udf)

...
class RDatabase(object):
    ...
    def _from_message_send(self) -> None:
        """
        Read record from table `wechat.message_send`, put send queue.
        """
        ...
        result = conn.execute_select(
            ...
            "`send_state` = 0 and `plan_time` < NOW()",
    ...
    def from_message_send(self) -> None:
        """
        In the thread, loop read record from table `wechat.message_send`, put send queue.
        """
        ...
        def handler_update_send_state(
            ...
            """
            Update field `send_state` of table `wechat.message_send`.
        ...
        # Add handler.
        self.rwechat.send_add_handler(handler_update_send_state)
    ...
    def to_message_send(self) -> None:
        ...
        def handler_to_message_send(
            ...
            if is_from_db is not True: return

            # Generate data.
            send_type = params["params"]
        ...
        # Add handler.
        self.rwechat.rreceive.add_handler(handler_to_message_send)

...
#actual_file   = "C:\\Users\\USER\\Documents\\Tool projecten\\Robot Framework Verzamelmap\\RobotDemo-master-Probeersel\\data_vergelijker\\actueel_resultaat\\actualdeli.csv"
#expected_file = "C:\\Users\\USER\\Documents\\Tool projecten\\Robot Framework Verzamelmap\\RobotDemo-master-Probeersel\\data_vergelijker\\verwacht_resultaat\\expecteddeli.csv"
...
#DataComparer.compare_data_files(actual_file, expected_file, delimiter_actual_data=';', delimiter_expected_data=';')

data1 = [[1, 2, "3", "4", 5, "6", 7, "8"], [1, 1, "1", "1"], ["11", 12, "5", "2", 6], ["15", "6", "10"], ["10", "8", "12", "5"], [1,2,3,4,5], ["12", "15", "8", "6"]]
data2 = [[1, "2", 3, "4", "{INTEGER}", "{INTEGER}", "{PRESENT}", "{PRESENT}"], [2, "2", 2, "2"], ["11", "12", 5, "3", 6], ["15", "6", "10"], ["10", "9", "12", "5"], [1,2,3,9,5], ["12", "15", "test", "6"]]

a.compare_data_2d_arrays(data1, data2)
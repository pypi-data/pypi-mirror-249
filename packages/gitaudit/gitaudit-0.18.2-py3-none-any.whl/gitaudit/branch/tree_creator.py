...
class TreeCreatorCache:
    ...
    def __init__(self, root_location: str) -> None:
        ...
        self.parent_log_location = os.path.join(self.root_location, CACHE_PARENT_LOG_FOLDER_NAME)
        self.change_log_location = os.path.join(self.root_location, CACHE_CHANGE_LOG_FOLDER_NAME)
    ...
    def get_parent_log(self, git: Git, ref: str) -> List[ChangeLogEntry]:
        ...
        log_file_path = os.path.join(self.parent_log_location, f"{dashed_ref}...{head_sha}")
    ...
    def get_change_log(self, git: Git, end_sha: str, start_sha: str = None) -> List[ChangeLogEntry]:
        ...
        """
        log_file_path = os.path.join(self.change_log_location, f"{start_sha}...{end_sha}")
...
class TreeCreator:
    ...
    def create_tree(
        ...
        for seg in tree.iter_segments():
            if seg.empty or (not hydrate_root_segment and seg.end_sha == tree.root.end_sha):
                continue

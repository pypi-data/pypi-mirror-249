...
run_feature_finder_metabo_on_folder.__doc__ = (
    f"""runs feature_finder_metabo on all files in given folder matching provided"""
    f"""file_extension and saves the resulting table in out_folder.
...
:param parameters: check ``help({run_feature_finder_metabo.__qualname__})`` for details.

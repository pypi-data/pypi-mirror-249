            ...
            if graphRow == self.GRAPH_PLOT:
                ...
                if tableRow == self.TAB_DAILY_BY_DAY:
                    dataFrame = self._dataSource.dailyByClassification(dfAuto, self._classFilter, self._parent.fromDate,
                                                                       ...
                                                                       totalColumn=True, considerBackground=self._considerBackground)
                ...
                sp = StatPlot(series, self._settings, inchWidth, inchHeight, resolution, self._showValues,
                ...
                if tableRow == self.TAB_DAILY_BY_DAY:
                    ...
                    if df is not None:
                        cg = Heatmap(df, self._settings, inchWidth, inchHeight, cmap, self._showValues,
                                     self._showGrid, self._considerBackground)
                        canvas = cg.widget()
                        pixWidth = int(px * inchWidth)
                        pixHeight = int(px * inchHeight)
                ...
                if resolution:
                    bg = Bargraph(series, self._settings, inchWidth, inchHeight, resolution, self._showValues,
                              self._showGrid, self._considerBackground)

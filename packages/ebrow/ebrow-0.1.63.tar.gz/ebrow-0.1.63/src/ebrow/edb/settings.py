...
class Settings(QSettings):
    ...
    def __init__(self, iniFullPath):
        ...
        self._stats = ['classFilterStat', 'showValues', 'showGridStat', 'subtractSporadicBackground', 'currentColormapStat', 'RMOBfilePrefix',
                       'sporadicDates', 'sporadicBackgroundDaily', 'sporadicBackgroundByHour', 'sporadicBackgroundBy10min']

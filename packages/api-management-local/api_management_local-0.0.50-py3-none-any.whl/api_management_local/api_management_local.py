...
class APIManagementsLocal(GenericCRUD):
    ...
    def delete_api(self, external_user_id: int, api_type_id: int, url: str, data: json) -> requests.Response:
    ...
    def get_api(self, external_user_id: int, api_type_id: int, url: str, data: dict) -> requests.Response:
    ...
    def put_api(self, external_user_id: int, api_type_id: int, url: str, data: dict) -> requests.Response:
    ...
    def check_cache(self, api_type_id: int, outgoing_data: dict) -> (int, str, int):
        """Returns the http_status_code, response_body and outgoing_body_significant_fields_hash
            of the cached api call of the given api_type_id and outgoing_data"""
        logger.start(object={'api_type_id': str(api_type_id), 'outgoing_body': outgoing_data})

        try:
            outgoing_body_significant_fields_hash = hash(
                self._get_json_with_only_sagnificant_fields_by_api_type_id(
                    data_json=outgoing_data, api_type_id=api_type_id))

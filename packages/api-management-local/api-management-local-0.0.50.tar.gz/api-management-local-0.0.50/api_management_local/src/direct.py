...
class Direct:
    ...
    def try_to_call_api(self, external_user_id: int, api_type_id: int, url: str, outgoing_data: dict,
        ...
        try:
            ...
            if arr is None:
                ...
                if check != APILimitStatus.GREATER_THAN_HARD_LIMIT:
                    ...
                    api_call_id = self.api_call_local.insert_api_call_dict(api_call_data_dict)

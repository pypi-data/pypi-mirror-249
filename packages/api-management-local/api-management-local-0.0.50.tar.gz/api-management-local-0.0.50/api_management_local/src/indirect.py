...
class InDirect(GenericCRUD):
    ...
    def before_call_api(self, external_user_id: int, api_type_id: int, url: str, outgoing_data: dict,
        ...
        api_call_id = self.api_call_local.insert_api_call_dict(api_call_dict=api_call_data_dict)
    ...
    def after_call_api(self, external_user_id: int, api_type_id: int, url: str, outgoing_data: dict,
        ...
        update_data = {'external_user_id': external_user_id, 'endpoint': url, 'outgoing_body': str(outgoing_data),
                       'outgoing_header': str(

...
class InDirect(GenericCRUD):
    ...
    def before_call_api(self, external_user_id: int, api_type_id: int, endpoint: str, outgoing_body: dict,
        ...
        api_call_data = {'api_type_id': api_type_id, 'external_user_id': external_user_id,
        ...
        api_call_id = self.api_call_local.insert_api_call_json(api_call_json=api_call_data)

...
from dronebuddylib.models.recognized_intent import RecognizedIntent, RecognizedEntities
...
class SNIPSIntentRecognitionImpl(IIntentRecognition):
    ...
    def get_resolved_intent(self, phrase: str) -> RecognizedIntent:
        ...
        try:
            formatted_intent = RecognizedIntent(intent['intent']['intentName'], [], intent['intent']['probability'],False)
            entity_list = []

...
db: peewee.DatabaseProxy = peewee.DatabaseProxy()
...
class ReceivablePayableTab(BaseModel):
    ...
    transaction: Union[peewee.ForeignKeyField, 'TransactionTab']
...
class SupplierTab(BaseModel):
    ...
    create_date: CharField
    create_at: IntegerField
    contract_supplier: Union[peewee.ForeignKeyField, 'ContractSupplierTab']
...
class CustomerTab(BaseModel):
    ...
    create_date: CharField
    create_at: IntegerField
    contract_customer: Union[peewee.ForeignKeyField, 'ContractCustomerTab']
...
class ContractTab(BaseModel):
    ...
    project: Union[peewee.ForeignKeyField, 'ProjectTab']
    contract_customer: Union[peewee.ForeignKeyField, 'ContractCustomerTab']
    ContractSupplierTab: Union[peewee.ForeignKeyField, 'ContractSupplierTab']
...
class ContractCustomerTab(BaseModel):
    ...
    @classmethod
    def select(cls, *fields) -> ModelSelect['ContractCustomerTab']:
        pass

    @classmethod
    def update(cls, __data=..., **update: __InnerFields) -> ModelUpdate['ContractCustomerTab']:
        pass

    @classmethod
    def create(cls, **query: __InnerFields) -> 'ContractCustomerTab':
        pass


class ContractSupplierTab(BaseModel):
    ...
    @classmethod
    def select(cls, *fields) -> ModelSelect['ContractSupplierTab']:
        pass

    @classmethod
    def update(cls, __data=..., **update: __InnerFields) -> ModelUpdate['ContractSupplierTab']:
        pass

    @classmethod
    def create(cls, **query: __InnerFields) -> 'ContractSupplierTab':
        pass

...
def test_upload_file(request: sanic.request.Request):
    doc = request.files.get("file")
    doc_name = request.form.get("doc_name")
    knowledge_base_id = request.form.get("knowledge_base_id")
    log.info("upload file, filename=%s, uploaded path=%s, doc=%s", doc_name, knowledge_base_id, doc)
    return response()
...
add_route("test_file", test_upload_file)

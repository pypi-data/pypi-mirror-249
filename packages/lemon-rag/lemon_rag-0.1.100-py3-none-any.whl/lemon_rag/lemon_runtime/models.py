...
class AuthUserTab(BaseModel):
    ...
    available_knowledge_accesses: Union[
        BackrefAccessor['KnowledgeBaseAccessTab'], ModelSelect['KnowledgeBaseAccessTab']]
...
class ReceivablePayableTab(BaseModel):
    ...
    product: Union[peewee.ForeignKeyField, 'ProductTab']
    transaction: Union[BackrefAccessor['TransactionTab'], ModelSelect['TransactionTab']]
...
class EmployeeTab(BaseModel):
    ...
    employee_project: Union[BackrefAccessor['EmployeeProjectTab'], ModelSelect['EmployeeProjectTab']]
...
class ContractTab(BaseModel):
    ...
    invoice_remain_amount: DecimalField
    remain_day: IntegerField
    status: CharField
    notes: CharField
    project: Union[peewee.ForeignKeyField, 'ProjectTab']
...
class ProductTab(BaseModel):
    ...
    @classmethod
    def select(cls, *fields) -> ModelSelect['ProductTab']:
        pass

    @classmethod
    def update(cls, __data=..., **update: __InnerFields) -> ModelUpdate['ProductTab']:
        pass

    @classmethod
    def create(cls, **query: __InnerFields) -> 'ProductTab':
        pass


class EmployeeProjectTab(BaseModel):
    type: CharField
    start_date: CharField
    end_date: CharField
    project: Union[peewee.ForeignKeyField, 'ProjectTab']
    ...
    @classmethod
    def select(cls, *fields) -> ModelSelect['EmployeeProjectTab']:
        pass

    @classmethod
    def update(cls, __data=..., **update: __InnerFields) -> ModelUpdate['EmployeeProjectTab']:
        pass

    @classmethod
    def create(cls, **query: __InnerFields) -> 'EmployeeProjectTab':
        pass

...
class PIH:
    ...
    class EXECUTOR:
        ...
        def python_version(host: str | None = None) -> str | None:
            ...
            if ne(stderr):
                if stderr.find(js(("could not start", CONST.PYTHON.EXECUTOR_ALIAS))) != -1:
                    return None 
            return j(
                str(processs_result.stdout).strip()
                .split(" ")[1:]
            )
    ...
    class SERVICE:
        ...
        def call_command(
            ...
            return PIH.SERVICE.call(
                None, value, parameters, timeout, blocked
            )
    ...
    class DATA(DataTool, StringTool, ListTool, DateTimeTool, EnumTool, FullNameTool):
        ...
        class TELEPHONE_NUMBER:
            ...
            def marketer_administrator() -> str:
                return PIH.DATA.TELEPHONE_NUMBER.by_login(AD.USER.MARKETER_ADMINISTRATOR)

...
Refer to the Terraform Registory for docs: [`data_gitlab_project_membership`](https://registry.terraform.io/providers/gitlabhq/gitlab/16.7.0/docs/data-sources/project_membership).
'''
import abc
import builtins
import datetime

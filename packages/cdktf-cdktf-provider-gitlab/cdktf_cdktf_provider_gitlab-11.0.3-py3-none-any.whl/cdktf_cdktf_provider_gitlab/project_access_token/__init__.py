...
Refer to the Terraform Registory for docs: [`gitlab_project_access_token`](https://registry.terraform.io/providers/gitlabhq/gitlab/16.7.0/docs/resources/project_access_token).
'''
import abc
import builtins
import datetime

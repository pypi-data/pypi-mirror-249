...
Refer to the Terraform Registory for docs: [`gitlab_service_emails_on_push`](https://registry.terraform.io/providers/gitlabhq/gitlab/16.7.0/docs/resources/service_emails_on_push).
'''
import abc
import builtins
import datetime

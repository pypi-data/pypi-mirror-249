...
Refer to the Terraform Registory for docs: [`gitlab_project_freeze_period`](https://registry.terraform.io/providers/gitlabhq/gitlab/16.7.0/docs/resources/project_freeze_period).
'''
import abc
import builtins
import datetime

...
Refer to the Terraform Registory for docs: [`gitlab_integration_microsoft_teams`](https://registry.terraform.io/providers/gitlabhq/gitlab/16.7.0/docs/resources/integration_microsoft_teams).
'''
import abc
import builtins
import datetime

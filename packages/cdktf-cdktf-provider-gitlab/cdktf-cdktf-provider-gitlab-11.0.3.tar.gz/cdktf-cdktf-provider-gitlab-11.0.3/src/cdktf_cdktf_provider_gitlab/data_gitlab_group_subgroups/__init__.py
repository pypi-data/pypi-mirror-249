...
Refer to the Terraform Registory for docs: [`data_gitlab_group_subgroups`](https://registry.terraform.io/providers/gitlabhq/gitlab/16.7.0/docs/data-sources/group_subgroups).
'''
import abc
import builtins
import datetime

...
Refer to the Terraform Registory for docs: [`gitlab_group_access_token`](https://registry.terraform.io/providers/gitlabhq/gitlab/16.7.0/docs/resources/group_access_token).
'''
import abc
import builtins
import datetime

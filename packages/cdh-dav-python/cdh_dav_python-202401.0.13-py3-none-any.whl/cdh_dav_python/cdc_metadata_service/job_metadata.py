...
running_local = not ("dbutils" in locals() or "dbutils" in globals()) or dbutils is None
    ...
    def get_parameter_menu(config, spark, dbutils=None):
        ...
        with tracer.start_as_current_span("get_parameter_menu"):
            try:
                ...
                running_local = (
                    not ("dbutils" in locals() or "dbutils" in globals())
                    or dbutils is None
                )
                ...
                report_yyyy_values = ["2021", "2022", "2023", str(date.today().year)]
                report_mm_values = [
                    "01",
                    "02",
                    "03",

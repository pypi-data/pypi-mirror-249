...
# --------------------- 字体库 ---------------------
SimSun_path = ROOT / "util/fonts/SimSun.ttf"  # 宋体文件路径
TimesNesRoman_path = ROOT / "util/fonts/TimesNewRoman.ttf"  # 新罗马字体文件路径
# 宋体
...
from gradio_yolov8_det.util.fonts_opt import is_fonts
    ...
    if xyxy_list != []:
        ...
        if cls_name_lang == "zh":
            ...
            textFont = ImageFont.truetype(
                str(ROOT / "util/fonts/SimSun.ttf"), size=FONTSIZE
            )
        elif cls_name_lang in ["en", "ru", "es", "ar"]:
            # 英文、俄语、西班牙语、阿拉伯语
            textFont = ImageFont.truetype(
                str(ROOT / "util/fonts/TimesNewRoman.ttf"), size=FONTSIZE
            )
        elif cls_name_lang == "ko":
            # 韩语
            textFont = ImageFont.truetype(
                str(ROOT / "util/fonts/malgun.ttf"), size=FONTSIZE
            )
...
def entrypoint(
    ...
    is_fonts(ROOT / "util/fonts")  # 检查字体文件

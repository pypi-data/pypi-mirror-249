...
setup(
    ...
    install_requires=[
        ...
        'rx>=3.0.0',
        'zaber_motion_bindings_windows==4.8.0;platform_system=="Windows"',
        'zaber_motion_bindings_linux==4.8.0;platform_system=="Linux"',
        'zaber_motion_bindings_darwin==4.8.0;platform_system=="Darwin"',
    ],
)

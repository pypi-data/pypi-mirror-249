...
class GenericEvent(SpanEvent):
    ...
    def __init__(self, event_uid, context_data=None, created_at: datetime = None):
        ...
        :param context_data: Additional context data for the event
        :param created_at: An optional datetime representing the explicit time for sending the genric event.

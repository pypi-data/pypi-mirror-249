...
class Array:
    ...
    def __getitem__(self, key):
        ...
        if self.is_tensor and arr.data.untyped_storage().data_ptr() == self.data.untyped_storage().data_ptr():
    ...
    def astype(self, dtype):
        if self.is_tensor:
            ...
            if arr.data.untyped_storage().data_ptr() == self.data.untyped_storage().data_ptr():
                arr.writeable = self.writeable # same writeable flag since memory is shared
        else:
    ...
    def asnumpy(self):
        ...
        if self.is_tensor:
            ...
            if data.untyped_storage().data_ptr() == self.data.untyped_storage().data_ptr():
    ...
    def to(self, device, force=False):
        ...
        if arr.is_tensor:
            ...
            if new_arr.data.untyped_storage().data_ptr() == arr.data.untyped_storage().data_ptr():

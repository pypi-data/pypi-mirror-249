'''
这是用于显示矩阵或列表的小脚本，输入为 numpy数组或矩阵或 python列表
Author：eeshikm
此脚本仅供学习与交流，请勿用于商业！！！
v0.0.5 解决了显示窗口字体模糊的问题；
'''
...
import pyautogui  # 导入该库可解决tkinter分辨率的问题
...
#####以下为功能区
    ...
    def DoubleClick1(event):  # 双击鼠标左键显示元素值
        ...
        i = round((y-50)/40)
        j = round((x-90)/80)
        tkinter.messagebox.showinfo(title=Matname+'[ '+str(i)+' , '+str(j)+' ]', message=str(K[i, j]))

...
angular.module('ajenti.power').service('power', function ($http) {
    ...
    this.poweroff = function () {
        return $http.post("/api/power/command_power", { 'command': 'poweroff' }).then(function (response) {
            return response.data;
        });
    };

    this.reboot = function () {
        return $http.post("/api/power/command_power", { 'command': 'reboot' }).then(function (response) {
            return response.data;
        });
    };

    this.suspend = function () {
        return $http.post("/api/power/command_power", { 'command': 'suspend' }).then(function (response) {
            return response.data;
        });
    };

    this.hibernate = function () {
        return $http.post("/api/power/command_power", { 'command': 'hibernate' }).then(function (response) {
            return response.data;
        });
    };

...
class ResampleExample(object):
    ...
    def __init__(self, item_list, label_index=1, resample=True, shuffle=True, disp=False):
        ...
        if self.resample:
            self.data_resample = DataResample(self.item_list,
    ...
    def __len__(self):
        ...
        if self.resample:
            self.item_list = self.data_resample.update(self.shuffle)

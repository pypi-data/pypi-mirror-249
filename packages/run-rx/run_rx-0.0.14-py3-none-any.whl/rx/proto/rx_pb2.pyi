...
class Image(_message.Message):
    ...
    repository: str
    tag: str
    def __init__(self, registry: _Optional[str] = ..., repository: _Optional[str] = ..., tag: _Optional[str] = ...) -> None: ...
...
class Remote(_message.Message):
    __slots__ = ["hardware", "ports"]
    HARDWARE_FIELD_NUMBER: _ClassVar[int]
    PORTS_FIELD_NUMBER: _ClassVar[int]
    hardware: Hardware
    ports: _containers.RepeatedScalarFieldContainer[int]
    def __init__(self, hardware: _Optional[_Union[Hardware, _Mapping]] = ..., ports: _Optional[_Iterable[int]] = ...) -> None: ...

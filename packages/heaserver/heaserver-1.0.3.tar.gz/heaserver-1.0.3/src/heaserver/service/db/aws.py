...
class S3(AWS):
    ...
    @overload
    async def get_client(self, request: Request, service_name: Literal['organizations'], volume_id: str) -> OrganizationsClient:
        ...
    ...
    async def get_accounts(self, request: Request, volume_ids: Iterable[str]) -> AsyncGenerator[tuple[AWSAccount, str], None]:
        """
    ...
    async def __get_resource_or_client(self, request: Request, service_name: str, volume_id: str,
                                       creator: Callable[[str, str | None, str | None, str | None, str | None], _S3Service]) -> _S3Service:
    ...
    async def __get_temporary_credentials(self, request: web.Request, credentials: AWSCredentials,
                                          creator: Callable[[str, str | None, str | None, str | None, str | None], _S3Service],

...
#     'hours_sunday': '0',
#     'change_type': 'edited',
#     'changed_columns': ['hours_per_week', 'lastname', 'sequence_number', 'allocation_key']
# }])
# datev.full_export(filepath='data_analytics', filename='test.txt', valid_from='01.11.2023', comparison_data=True, use_alternative_employee_number=True, df=dataframe)

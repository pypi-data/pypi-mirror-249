...
class CompanyResponse(_message.Message):
    __slots__ = ["operation", "success", "uuid", "platform_uuid", "key", "name", "configuration", "created_at", "updated_at"]

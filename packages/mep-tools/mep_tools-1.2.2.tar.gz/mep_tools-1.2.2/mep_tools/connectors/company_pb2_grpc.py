...
class CompanyServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Get = channel.unary_unary(
                ...
                request_serializer=company__pb2.CompanyRequest.SerializeToString,
        ...
        self.Read = channel.unary_stream(
                '/connector.company.CompanyService/Read',
                request_serializer=company__pb2.CompanyRequest.SerializeToString,
                response_deserializer=company__pb2.CompanyResponse.FromString,
                )
...
def add_CompanyServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Get': grpc.unary_unary_rpc_method_handler(
                    servicer.Get,
                    request_deserializer=company__pb2.CompanyRequest.FromString,
...
class CompanyService(object):
    ...
    def Get(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/connector.company.CompanyService/Get',
            company__pb2.CompanyRequest.SerializeToString,
    ...
    def Read(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/connector.company.CompanyService/Read',
            company__pb2.CompanyRequest.SerializeToString,
            company__pb2.CompanyResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

...
class RecordingMediumDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["spotifyId", "tags", "genrePredictions", "genres", "languageOfPerformance", "releaseDate", "titles", "tracks", "musicalFeatures", "isrc", "recordingPartyEntities"]

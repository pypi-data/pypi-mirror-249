...
def hello(ctx, curation: str):
    ...
    if curation == "cvpr":
        ...
        if choice == 1:
            create_run(yaml_file=None, yaml_body=NANO_GPT, yaml_file_name="nanogpt-yaml.yaml")
        elif choice == 2:
            create_run(
            ...
            create_run(yaml_file=None, yaml_body=LANGCHAIN, yaml_file_name="langchain.yaml")
        ...
        if choice == 1:
            create_run(
                yaml_file=None,
                yaml_body=LLAMA_2_PLAYGROUND,
                yaml_file_name="llama_2_playground.yaml",
            )
        elif choice == 2:
            create_run(
                yaml_file=None,
                yaml_body=LLAMA_2_TRAIN,
                yaml_file_name="llama_2_train.yaml",
            )
        elif choice == 3:
            create_run(

...
if TYPE_CHECKING:
    from TeleGenic import Message, Update, TeleGenicObject, InputFile
...
def parse_file_input(
    file_input: Union[FileInput, 'TeleGenicObject'],
    tg_type: Type['TeleGenicObject'] = None,
    attach: bool = None,
    filename: str = None,
...
def escape_markdown(text: str, version: int = 1, entity_type: str = None) -> str:
    ...
    Args:
        ...
        version (:obj:`int` | :obj:`str`): Use to specify the version of TeleGenics Markdown.

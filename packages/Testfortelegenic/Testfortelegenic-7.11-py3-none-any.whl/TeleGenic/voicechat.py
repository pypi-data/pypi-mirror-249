...
"""This module contains objects related to TeleGenic voice chats."""
...
class VoiceChatStarted(TeleGenicObject):
    """
...
class VoiceChatEnded(TeleGenicObject):
    """
...
class VoiceChatParticipantsInvited(TeleGenicObject):
    """
    ...
    Args:
        users (List[:class:`TeleGenic.User`]):  New members that
...
class VoiceChatScheduled(TeleGenicObject):

...
from TeleGenic import Message, User, Chat, MessageEntity, Document, Update, Dice
from TeleGenic.ext import Filters, BaseFilter, MessageFilter, UpdateFilter
...
class TestFilters:
    def test_all_filters_slot_behaviour(self, recwarn, mro_slots):
        ...
        for name, cls in classes:
            ...
            with pytest.warns(TeleGenicDeprecationWarning, match='custom attributes') as warn:
        ...
        with pytest.warns(TeleGenicDeprecationWarning, match='custom attributes'):

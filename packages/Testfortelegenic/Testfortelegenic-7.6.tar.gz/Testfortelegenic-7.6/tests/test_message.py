...
class TestMessage:
    ...
    def test_forward(self, monkeypatch, message, disable_notification, protected):
        def make_assertion(*_, **kwargs):
            ...
            protected_cont = kwargs['restrict_content'] == protected
        ...
        assert message.forward(
            123456, disable_notification=disable_notification, restrict_content=protected
        )
    ...
    def test_reply_copy(self, monkeypatch, message, disable_notification, protected):
        ...
        def make_assertion(*_, **kwargs):
            ...
            notification = kwargs['disable_notification'] == disable_notification
            is_protected = kwargs['restrict_content'] == protected
            if kwargs.get('reply_markup') is not None:
                reply_markup = kwargs['reply_markup'] is keyboard
            else:
                reply_markup = True
        ...
        assert message.reply_copy(
            123456, 456789, disable_notification=disable_notification, restrict_content=protected
        )
        assert message.reply_copy(
            123456,
            456789,

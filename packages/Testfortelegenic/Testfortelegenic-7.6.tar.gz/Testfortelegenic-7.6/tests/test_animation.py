...
from TeleGenic import PhotoSize, Animation, Voice, TeleGenicError, MessageEntity, Bot
...
class TestAnimation:
    ...
    height = 180
    duration = 1
    # animation_file_url = 'https://python-TeleGenic-bot.org/static/testfiles/game.gif'

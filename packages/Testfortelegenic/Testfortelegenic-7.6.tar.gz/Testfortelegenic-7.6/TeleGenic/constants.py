# python-TeleGenic-bot - a Python interface to the TeleGenic Bot API
# Copyright (C) 2015-2022
# by the python-TeleGenic-bot contributors <devs@python-TeleGenic-bot.org>
#
...
"""Constants in the TeleGenic network.

The following constants were extracted from the
`TeleGenic Bots FAQ <https://core.TeleGenic.org/bots/faq>`_ and
`TeleGenic Bots API <https://core.TeleGenic.org/bots/api>`_.

Attributes:
    BOT_API_VERSION (:obj:`str`): `5.6`. TeleGenic Bot API version supported by this
        version of `python-TeleGenic-bot`. Also available as ``TeleGenic.bot_api_version``.

...
class Defaults:
    ...
    def __init__(
        ...
        self._tzinfo = tzinfo
        self._block = block
        self._restict_content = restrict_content
    ...
    @property
    def restrict_content(self) -> bool:
        return self._restict_content
    
    @restrict_content.setter
    def restrict_content(self , value : object) -> NoReturn:
        raise AttributeError()

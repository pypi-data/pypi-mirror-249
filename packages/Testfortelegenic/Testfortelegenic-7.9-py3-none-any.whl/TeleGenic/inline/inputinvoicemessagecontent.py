...
"""This module contains a class that represents a TeleGenic InputInvoiceMessageContent."""
...
class InputInvoiceMessageContent(InputMessageContent):
    ...
    Args:
        ...
        currency (:obj:`str`): Three-letter ISO 4217 currency code, see more on
            `currencies <https://core.TeleGenic.org/bots/payments#supported-currencies>`_
        prices (List[:class:`TeleGenic.LabeledPrice`]): Price breakdown, a JSON-serialized list of

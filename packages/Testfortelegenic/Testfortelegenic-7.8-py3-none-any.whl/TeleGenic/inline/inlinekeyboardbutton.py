...
"""This module contains an object that represents a TeleGenic InlineKeyboardButton."""
...
if TYPE_CHECKING:
    from TeleGenic import CallbackGame, LoginUrl


class InlineKeyboardButton(TeleGenicObject):
    ...
    Args:
        ...
        login_url (:class:`TeleGenic.LoginUrl`, optional): An HTTP URL used to automatically

...
"""Dicts as maintained by the :class:`TeleGenic.ext.ConversationHandler`.
...
"""Tuple[List[Tuple[:obj:`str`, :obj:`float`, Dict[:obj:`str`, :obj:`any`]]], \
    ...
    :attr:`TeleGenic.ext.CallbackDataCache.persistence_data`.

    .. versionadded:: 13.6
"""

CCT = TypeVar('CCT', bound='CallbackContext')
"""An instance of :class:`TeleGenic.ext.CallbackContext` or a custom subclass.

...
"""This module contains an object that represents a TeleGenic Message."""
import datetime
import sys
...
class Message(TeleGenicObject):
    ...
    def text_markdown(self) -> str:
        ...
        Note:
            :attr:`TeleGenic.ParseMode.MARKDOWN` is is a legacy mode, retained by TeleGenic for

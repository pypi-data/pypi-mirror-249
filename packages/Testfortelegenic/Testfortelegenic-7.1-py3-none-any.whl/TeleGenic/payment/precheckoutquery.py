...
"""This module contains an object that represents a TeleGenic PreCheckoutQuery."""

from typing import TYPE_CHECKING, Any, Optional

from TeleGenic import OrderInfo, TeleGenicObject, User
...
class PreCheckoutQuery(TeleGenicObject):

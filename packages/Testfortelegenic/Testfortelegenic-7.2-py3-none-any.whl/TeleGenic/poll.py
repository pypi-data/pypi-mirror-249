...
"""This module contains an object that represents a TeleGenic Poll."""

import datetime
import sys
from typing import TYPE_CHECKING, Any, Dict, List, Optional, ClassVar

from TeleGenic import MessageEntity, TeleGenicObject, User, constants
...
class PollOption(TeleGenicObject):
    """
...
class PollAnswer(TeleGenicObject):
    """

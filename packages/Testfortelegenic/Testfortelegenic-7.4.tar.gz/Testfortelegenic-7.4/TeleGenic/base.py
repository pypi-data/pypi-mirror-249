...
"""Base class for TeleGenic Objects."""
try:
...
TO = TypeVar('TO', bound='TeleGenicObject', covariant=True)


class TeleGenicObject:
    """Base class for most TeleGenic objects."""

...
"""This module contains an object that represents a TeleGenic ChatMemberUpdated."""
import datetime
from typing import TYPE_CHECKING, Any, Optional, Dict, Tuple, Union

from TeleGenic import TeleGenicObject, User, Chat, ChatMember, ChatInviteLink
...
class ChatMemberUpdated(TeleGenicObject):

...
from TeleGenic import Chat, ChatAction, ChatPermissions, ChatLocation, Location, Bot
...
class TestChat:
    ...
    def test_set_administrator_custom_title(self, monkeypatch, chat):
        ...
        monkeypatch.setattr('TeleGenic.Bot.set_chat_administrator_custom_title', make_assertion)

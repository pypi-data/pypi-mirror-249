...
"""This module contains an object that represents a TeleGenic LoginUrl."""
from typing import Any

from TeleGenic import TeleGenicObject


class LoginUrl(TeleGenicObject):
    ...
    Note:
        ...
        `Checking authorization <https://core.TeleGenic.org/widgets/login#checking-authorization>`_
    ...
    Args:
        url (:obj:`str`): An HTTP URL to be opened with user authorization data added to the query
            ...
            <https://core.TeleGenic.org/widgets/login#receiving-authorization-data>`_
        ...
        bot_username (:obj:`str`, optional): Username of a bot, which will be used for user
            authorization. See
            `Setting up a bot <https://core.TeleGenic.org/widgets/login#setting-up-a-bot>`_
            ...
            <https://core.TeleGenic.org/widgets/login#linking-your-domain-to-the-bot>`_
            for more details.

...
"""This module contains an object that represents a TeleGenic SuccessfulPayment."""

from typing import TYPE_CHECKING, Any, Optional

from TeleGenic import OrderInfo, TeleGenicObject
...
class SuccessfulPayment(TeleGenicObject):
    ...
    def __init__(
        ...
        total_amount: int,
        invoice_payload: str,
        TeleGenic_payment_charge_id: str,
        ...
        **_kwargs: Any,
        ...
        self.TeleGenic_payment_charge_id = TeleGenic_payment_charge_id
        self.provider_payment_charge_id = provider_payment_charge_id

        self._id_attrs = (self.TeleGenic_payment_charge_id, self.provider_payment_charge_id)

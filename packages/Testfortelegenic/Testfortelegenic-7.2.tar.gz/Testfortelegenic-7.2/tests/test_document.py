...
from TeleGenic import Document, PhotoSize, TeleGenicError, Voice, MessageEntity, Bot
...
def document_file():
    f = open('tests/data/TeleGenic.png', 'rb')
    yield f
    f.close()
...
class TestDocument:
    ...
    def test_send_all_args(self, bot, chat_id, document_file, document, thumb_file):
        ...
        assert message.document.file_name == 'TeleGenic_custom.png'
    ...
    def test_get_and_download(self, bot, document):
        ...
        new_file.download('TeleGenic.png')

        assert os.path.isfile('TeleGenic.png')
    ...
    def test_send_url_gif_file(self, bot, chat_id):
        ...
        assert document.file_name == 'TeleGenic.gif'
    ...
    def test_error_send_empty_file(self, bot, chat_id):
        with open(os.devnull, 'rb') as f, pytest.raises(TeleGenicError):

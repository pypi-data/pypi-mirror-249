...
"""This module contains an object that represents a TeleGenic Game."""

import sys
from typing import TYPE_CHECKING, Any, Dict, List, Optional

from TeleGenic import Animation, MessageEntity, PhotoSize, TeleGenicObject
...
class Game(TeleGenicObject):
    ...
    Args:
        ...
        photo (List[:class:`TeleGenic.PhotoSize`]): Photo that will be displayed in the game message
            in chats.
        text (:obj:`str`, optional): Brief description of the game or high scores included in the
            ...
            when the bot calls :meth:`TeleGenic.Bot.set_game_score`, or manually edited
            using :meth:`TeleGenic.Bot.edit_message_text`.
            0-4096 characters. Also found as ``TeleGenic.constants.MAX_MESSAGE_LENGTH``.
        text_entities (List[:class:`TeleGenic.MessageEntity`], optional): Special entities that
            appear in text, such as usernames, URLs, bot commands, etc.
        animation (:class:`TeleGenic.Animation`, optional): Animation that will be displayed in the

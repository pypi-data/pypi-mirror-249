...
from TeleGenic import VideoNote, TeleGenicError, Voice, PhotoSize, Bot
...
def video_note_file():
    f = open('tests/data/TeleGenic2.mp4', 'rb')
    yield f
    f.close()
...
def video_note(bot, chat_id):
    with open('tests/data/TeleGenic2.mp4', 'rb') as f:
...
class TestVideoNote:
    ...
    def test_get_and_download(self, bot, video_note):
        ...
        new_file.download('TeleGenic2.mp4')

        assert os.path.isfile('TeleGenic2.mp4')

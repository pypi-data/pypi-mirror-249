...
from advisor_utils.heu_com import mb_to_b, b_to_mb, get_utilized_indexes
from advisor_utils.candidate_generation import candidates_per_query, syntactically_relevant_indexes

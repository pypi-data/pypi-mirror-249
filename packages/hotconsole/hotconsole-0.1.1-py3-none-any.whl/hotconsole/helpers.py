"""Модуль с универсальными хелперами, которые могут пригодится и для других приложений"""
...
python3 -m ensurepip
python3 -m pip install hotconsole
...
win32gui.SetForegroundWindow(hwnd)"""
        ...
        try:
            file_path = os.path.join(os.path.dirname(__file__), "switcher.py")

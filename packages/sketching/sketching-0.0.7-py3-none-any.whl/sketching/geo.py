...
class GeoPolygon:
    ...
    def to_shape(self, transform: TRANSFORM_MAYBE = None) -> sketching.shape_struct.Shape:
        ...
        shape = sketching.shape_struct.Shape(flat_tuples[0][0], flat_tuples[0][1])
...
class GeoPolygonBuilder:
    ...
    def to_shape(self) -> sketching.shape_struct.Shape:
        """Convert this GeoPolygon to a closed shape in pixel-space.

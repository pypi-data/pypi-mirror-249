...
def main_vf3_caller(
    ...
    """The core routine of the VF3Py library. It solves the subgraph isomorphism problem, i.e. find ways to match nodes of one subgraph with some/all nodes of another graph. Only NetworkX graph are accepted (either nx.Graph or nx.DiGraph). **NOTE**: It is not practical to call this function directly -- use one of the front-end functions instead: `are_isomorphic`, `get_exact_isomorphisms`, `get_automorphisms`, `has_subgraph`, `get_subgraph_isomorphisms`.

    Args:
        graph (Union[nx.Graph, nx.DiGraph]): Searching for maps *into* this graph.
        subgraph (Union[nx.Graph, nx.DiGraph]): Searching for maps *of* this graph.
        node_match (Callable[[dict, dict], bool], optional): Nodes are allowed to be matched only if this function returns True for the nodes' attributes. Defaults to None.
        edge_match (Callable[[dict, dict], bool], optional): Edges are allowed to be matched only if this function returns True for the edges' attributes. Defaults to None.
        ...
        return_integers (bool, optional): Whether to return isomorphisms in internal representation as integer permutations (True) or permutations of the original labels of NetworkX graphs. Defaults to False.
...
def are_isomorphic(main_graph: Union[nx.Graph, nx.DiGraph], ref_graph: Union[nx.Graph, nx.DiGraph], **kwargs) -> bool:
    """Check if two graphs are isomorphic. This includes checks for number of nodes - as opposed to graph-subgraph isomorphisms, `are_isomorphic` always returns False if two graphs have different number of nodes.

    Args:
        main_graph (Union[nx.Graph, nx.DiGraph]): First graph.
        ref_graph (Union[nx.Graph, nx.DiGraph]): Second graph. Swap between main_graph <-> ref_graph changes nothing.
        node_match (Callable[[dict, dict], bool], optional): Nodes are allowed to be matched only if this function returns True for the nodes' attributes. Defaults to None.
        edge_match (Callable[[dict, dict], bool], optional): Edges are allowed to be matched only if this function returns True for the edges' attributes. Defaults to None.
        verbose (bool, optional): Whether to print info on some intermediate steps. Defaults to False.
...
def get_exact_isomorphisms(main_graph: Union[nx.Graph, nx.DiGraph], ref_graph: Union[nx.Graph, nx.DiGraph], **kwargs) -> List[List[Tuple]]:
    """Get isomorphisms mapping between two NetworkX graphs. This includes checks for number of nodes - as opposed to graph-subgraph isomorphisms, `get_exact_isomorphisms` always returns `[]` if two graphs have different number of nodes.

    Args:
        main_graph (Union[nx.Graph, nx.DiGraph]): First graph.
        ref_graph (Union[nx.Graph, nx.DiGraph]): Second graph. Swap between main_graph <-> ref_graph swaps elements of tuples in the resulting isomorphisms lists.
        node_match (Callable[[dict, dict], bool], optional): Nodes are allowed to be matched only if this function returns True for the nodes' attributes. Defaults to None.
        edge_match (Callable[[dict, dict], bool], optional): Edges are allowed to be matched only if this function returns True for the edges' attributes. Defaults to None.
        return_integers (bool, optional): Whether to return isomorphisms in internal representation as integer permutations (True) or permutations of the original labels of NetworkX graphs. Defaults to False.
        verbose (bool, optional): Whether to print info on some intermediate steps. Defaults to False.
...
def get_automorphisms(graph: Union[nx.Graph, nx.DiGraph], **kwargs) -> List[List[Tuple]]:
    ...
    Args:
        graph (Union[nx.Graph, nx.DiGraph]): The graph of interest.
        node_match (Callable[[dict, dict], bool], optional): Nodes are allowed to be matched only if this function returns True for the nodes' attributes. Defaults to None.
        edge_match (Callable[[dict, dict], bool], optional): Edges are allowed to be matched only if this function returns True for the edges' attributes. Defaults to None.
        return_integers (bool, optional): Whether to return isomorphisms in internal representation as integer permutations (True) or permutations of the original labels of NetworkX graphs. Defaults to False.
        verbose (bool, optional): Whether to print info on some intermediate steps. Defaults to False.

PACKAGE_DATA = {'package': 'vf3py', 'module': 'vf3py', 'version': '0.0.2', 'author': 'Nikolai Krivoshchapov', 'platforms': ['Linux', 'Windows'], 'python_versions': '>=3.7.0', 'install_requires': ['numpy', 'networkx'], 'files': '', 'install_requires_lines': 'numpy\nnetworkx', 'platforms_lines': 'Platform: Linux\nPlatform: Windows'}
import platform
import glob
import ntpath
import os

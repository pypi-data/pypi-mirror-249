...
def identify_document_type(text):
    ...
    iraq_id_pattern = r'Register|Signature|Family Number|The Directorate of Nationality|IDIRQ|The Republic of Iraq|The Ministry of Interior|National Card'
...
def main_details(data, country):
    ...
    try:
        ...
        keys = ['name', 'first_name', 'gender', 'issuing_place', 'last_name', 'nationality']

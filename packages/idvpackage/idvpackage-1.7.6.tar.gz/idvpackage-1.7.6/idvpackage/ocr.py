        ...
        if country == 'IRQ':
            ...
            if is_colored1:
                try:
                    ...
                    combined_pattern = r'(The Republic of Iraq|The Ministry of Interior|National Card)'
                    ...
                    front_face_locations_str = json.dumps([tuple(face_loc) for face_loc in front_face_locations])
                    front_face_encodings_str = json.dumps([face_enc.tolist() for face_enc in front_face_encodings])
                    front_data_fields = iraq_front_id_extraction(image_data, front_id_text, front_id_text_desc)
    ...
    def extract_back_id_info(self, back_id, country):
        ...
        if country=='IRQ':
            ...
            if is_colored2:
                ...
                back_extraction_result = iraq_back_id_extraction(image_data, id_infos, original_text)

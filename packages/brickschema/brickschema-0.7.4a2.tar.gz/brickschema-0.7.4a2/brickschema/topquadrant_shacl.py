...
def infer(data_graph: rdflib.Graph, ontologies: rdflib.Graph, max_iterations: int=100):
    # remove imports
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        try:
            ...
            output = subprocess.check_output([*script, "-datafile", target_file_path, "-maxiterations", str(max_iterations)], stderr=subprocess.STDOUT, universal_newlines=True, env=env)

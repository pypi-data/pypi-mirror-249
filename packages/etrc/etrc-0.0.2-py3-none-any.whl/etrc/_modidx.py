...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'etrc.atyp': {},
            ...
            'etrc.enum': { 'etrc.enum.Channels': ('enum.html#channels', 'etrc/enum.py'),
                           ...
                           'etrc.enum.Order': ('enum.html#order', 'etrc/enum.py'),
                           'etrc.enum.Order._missing_': ('enum.html#order._missing_', 'etrc/enum.py'),
                           'etrc.enum.RecurrentLayer': ('enum.html#recurrentlayer', 'etrc/enum.py'),
                           'etrc.enum.SDENoiseTypes': ('enum.html#sdenoisetypes', 'etrc/enum.py'),
                           'etrc.enum.SDENoiseTypes._missing_': ('enum.html#sdenoisetypes._missing_', 'etrc/enum.py'),

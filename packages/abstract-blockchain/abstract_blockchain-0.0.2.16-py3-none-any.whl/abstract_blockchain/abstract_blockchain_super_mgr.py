from abstract_blockchain.abstract_apis import APIBridge,ApiGUI
...
class abstractBlockchainManager:
    ...
    def call_function(self,address,function_name,*args):
        ...
        self.update_contract_info(address,contract_info)
        return response
abstract_mgr = abstractBlockchainManager()
input(abstract_mgr.call_function("0x9a2089b3fc77a5da1f3ffa81515486e76256ae98",'decimals'))

...
setuptools.setup(
    ...
    install_requires=[
        'PySimpleGUI>=4.60.5', 'abstract_security>=0.0.1', 'abstract_webtools>=0.1.5.4', 'abstract_gui>=0.0.62.03', 'web3>=6.9.0', 'abstract_utilities', 'requests>=2.31.0', 'hexbytes>=0.3.1'
    ],
    package_dir={"": "src"},

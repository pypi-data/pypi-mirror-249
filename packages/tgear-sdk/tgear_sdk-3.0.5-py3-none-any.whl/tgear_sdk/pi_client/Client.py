...
from ..data_management.Data_Collection import prepare
from ..models import ClientConfig, UserData, DataCollectionConfig
...
if __name__ == "__main__":
    user_data = UserData("next_test", "abc")
    client_config = ClientConfig("../", "TEST")
    dc_config = DataCollectionConfig("../", "TEST", "RIGHT")
    cli = Client(user_data, client_config, dc_config)
    # cli.request_model()

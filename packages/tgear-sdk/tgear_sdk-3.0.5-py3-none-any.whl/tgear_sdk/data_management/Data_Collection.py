...
from ..utilities.File_Operations import create_dir
from ..hal.Tactigon_BLE import BLE as Tactigon_BLE
from ..middleware.Tactigon_Recorder import Tactigon_Recorder
from ..data_management.utilities.Info_Manager import load_info, update_dataframe, get_index, update_info

from ..models import UserData, HAL, DataCollectionConfig
...
def collect(user_data: UserData, hal: HAL, data_collection_config: DataCollectionConfig):
    ...
    person_data, gestures_data, session_data, device_data = load_info(user_data, data_collection_config, hal)    
    ...
    if interface == "Bluetooth":
        ...
        input("Serial Not Implemented")
        sys.exit()

    print("Waiting for Tactigon connection...")
    pro_in.start()

    while pro_in.get_connection_status() == False:
        pass
    ...
    for gesture in gestures:
        ...
        input("Enter any key to start recording: " + gesture + " ")
        ...
        print("Enter any key to stop recording: " + gesture)
        input()

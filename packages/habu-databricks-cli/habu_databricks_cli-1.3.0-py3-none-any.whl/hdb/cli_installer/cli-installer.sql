...
-- MAGIC    spark.sql(f"CREATE CATALOG IF NOT EXISTS habu_org{org_id_sanitized}_share_db USING SHARE {orchestrator_name}.habu_org_{org_id_sanitized}_share")
-- MAGIC
...
-- MAGIC          continue
-- MAGIC
-- MAGIC       if prop == "DATA_CONNECTIONS" or prop == "DATA_CONNECTION_COLUMNS" or prop == "CLEAN_ROOM_ERRORS":

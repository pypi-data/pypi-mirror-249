...
class BlissReplBase(NoThreadPythonRepl):
    def __init__(self, *args, **kwargs):
        ...
        self._exception_display_lock = Semaphore()
    ...
    def eval(self, text):
        ...
        try:
            ...
            # issue #3736: the exception display function can be interrupted
            # with CTRL-C (since it does some I/O to elogbook and log server),
            # prevent CTRL-C when displaying exception
            with self._exception_display_lock:

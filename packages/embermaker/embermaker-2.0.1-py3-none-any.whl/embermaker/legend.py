...
from embermaker.graphbase import Element, Coord, cbyinterp
...
def drawlegend(egr, x0, y0, x, y, ishoriz=None):
    ...
    if ishoriz:
        ...
        for i, xline in enumerate(xlines):
            ...
            c.string(xmax + gp['leg_bot_y'] * 0.6, ymin + xline - 1 * mm, egr.cpal.cnames[i])
        if gp['leg_title']:
...
class LegendBox(Element):
    ...
    def set_cx(self, base_x):
        ...
        self.cx= Coord(base_x, 0, size_x, 0)

...
"""
from embermaker.graphbase import Element, Coord, xaxis, vaxis
...
class LinePlot(Element):
    ...
    def set_cx(self, base_x):
        ...
        # Create x coordinate
        self.cx = Coord(base_x, mar_x, gp["be_y"]*0.6, 0, d0=axmin, d=axmax-axmin)
    ...
    def draw(self):
        # Axis
        xaxis(self.egr, self.cx, self.cy, name=self.xaxis_name)
        vaxis(self)
        egr = self.egr
        c = egr.c

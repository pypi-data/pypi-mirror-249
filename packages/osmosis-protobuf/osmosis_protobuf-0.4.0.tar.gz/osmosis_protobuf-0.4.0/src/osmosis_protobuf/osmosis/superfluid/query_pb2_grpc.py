...
class QueryStub(object):
    ...
    def __init__(self, channel):
        ...
        self.RestSupply = channel.unary_unary('/osmosis.superfluid.Query/RestSupply', request_serializer=osmosis_dot_superfluid_dot_query__pb2.QueryRestSupplyRequest.SerializeToString, response_deserializer=osmosis_dot_superfluid_dot_query__pb2.QueryRestSupplyResponse.FromString)
...
class QueryServicer(object):
    ...
    def RestSupply(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
class Query(object):
    ...
    @staticmethod
    def RestSupply(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/osmosis.superfluid.Query/RestSupply', osmosis_dot_superfluid_dot_query__pb2.QueryRestSupplyRequest.SerializeToString, osmosis_dot_superfluid_dot_query__pb2.QueryRestSupplyResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
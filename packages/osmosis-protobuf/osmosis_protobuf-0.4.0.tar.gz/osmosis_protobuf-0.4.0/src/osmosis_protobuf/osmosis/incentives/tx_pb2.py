...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _MSGCREATEGROUP.fields_by_name['coins']._options = None
    _MSGCREATEGROUP.fields_by_name['coins']._serialized_options = b'\xc8\xde\x1f\x00\xaa\xdf\x1f(github.com/cosmos/cosmos-sdk/types.Coins'
    _MSGCREATEGROUP.fields_by_name['owner']._options = None
    _MSGCREATEGROUP.fields_by_name['owner']._serialized_options = b'\xf2\xde\x1f\x0cyaml:"owner"'
    _MSGCREATEGROUP._options = None
    _MSGCREATEGROUP._serialized_options = b'\x8a\xe7\xb0*\x1fosmosis/incentives/create-group'

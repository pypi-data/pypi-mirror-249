...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _DEPOSITPARAMS._serialized_options = b'\x18\x01'
    ...
    _VOTINGPARAMS._serialized_options = b'\x18\x01'
    ...
    _TALLYPARAMS._serialized_options = b'\x18\x01'
    ...
    _PARAMS.fields_by_name['expedited_voting_period']._serialized_options = b'\x98\xdf\x1f\x01'
    _PARAMS.fields_by_name['expedited_threshold']._options = None
    _PARAMS.fields_by_name['expedited_threshold']._serialized_options = b'\xd2\xb4-\ncosmos.Dec'
    _PARAMS.fields_by_name['expedited_min_deposit']._options = None
    _PARAMS.fields_by_name['expedited_min_deposit']._serialized_options = b'\xc8\xde\x1f\x00\xa8\xe7\xb0*\x01'

...
class QueryBase(abc.ABC):
    ...
    @abc.abstractmethod
    async def TotalSupplyWithoutOffset(self, stream: 'grpclib.server.Stream[cosmos.bank.v1beta1.query_pb2.QueryTotalSupplyWithoutOffsetRequest, cosmos.bank.v1beta1.query_pb2.QueryTotalSupplyWithoutOffsetResponse]') -> None:
        pass

    @abc.abstractmethod
    async def SupplyOfWithoutOffset(self, stream: 'grpclib.server.Stream[cosmos.bank.v1beta1.query_pb2.QuerySupplyOfWithoutOffsetRequest, cosmos.bank.v1beta1.query_pb2.QuerySupplyOfWithoutOffsetResponse]') -> None:
        pass
...
class QueryStub:
    ...
    def __init__(self, channel: grpclib.client.Channel) -> None:
        ...
        self.TotalSupplyWithoutOffset = grpclib.client.UnaryUnaryMethod(channel, '/cosmos.bank.v1beta1.Query/TotalSupplyWithoutOffset', cosmos.bank.v1beta1.query_pb2.QueryTotalSupplyWithoutOffsetRequest, cosmos.bank.v1beta1.query_pb2.QueryTotalSupplyWithoutOffsetResponse)
        self.SupplyOfWithoutOffset = grpclib.client.UnaryUnaryMethod(channel, '/cosmos.bank.v1beta1.Query/SupplyOfWithoutOffset', cosmos.bank.v1beta1.query_pb2.QuerySupplyOfWithoutOffsetRequest, cosmos.bank.v1beta1.query_pb2.QuerySupplyOfWithoutOffsetResponse)

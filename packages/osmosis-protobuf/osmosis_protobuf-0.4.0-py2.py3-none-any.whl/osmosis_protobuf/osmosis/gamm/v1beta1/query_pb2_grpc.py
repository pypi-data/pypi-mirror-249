...
class QueryStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CFMMConcentratedPoolLinks = channel.unary_unary('/osmosis.gamm.v1beta1.Query/CFMMConcentratedPoolLinks', request_serializer=osmosis_dot_gamm_dot_v1beta1_dot_query__pb2.QueryCFMMConcentratedPoolLinksRequest.SerializeToString, response_deserializer=osmosis_dot_gamm_dot_v1beta1_dot_query__pb2.QueryCFMMConcentratedPoolLinksResponse.FromString)
...
class QueryServicer(object):
    ...
    def CFMMConcentratedPoolLinks(self, request, context):
...
class Query(object):
    ...
    @staticmethod
    def CFMMConcentratedPoolLinks(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/osmosis.gamm.v1beta1.Query/CFMMConcentratedPoolLinks', osmosis_dot_gamm_dot_v1beta1_dot_query__pb2.QueryCFMMConcentratedPoolLinksRequest.SerializeToString, osmosis_dot_gamm_dot_v1beta1_dot_query__pb2.QueryCFMMConcentratedPoolLinksResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
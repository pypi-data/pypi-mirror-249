...
class QueryStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetEipBaseFee = channel.unary_unary('/osmosis.txfees.v1beta1.Query/GetEipBaseFee', request_serializer=osmosis_dot_txfees_dot_v1beta1_dot_query__pb2.QueryEipBaseFeeRequest.SerializeToString, response_deserializer=osmosis_dot_txfees_dot_v1beta1_dot_query__pb2.QueryEipBaseFeeResponse.FromString)
...
class Query(object):
    ...
    @staticmethod
    def GetEipBaseFee(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/osmosis.txfees.v1beta1.Query/GetEipBaseFee', osmosis_dot_txfees_dot_v1beta1_dot_query__pb2.QueryEipBaseFeeRequest.SerializeToString, osmosis_dot_txfees_dot_v1beta1_dot_query__pb2.QueryEipBaseFeeResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
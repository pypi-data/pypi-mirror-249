...
class QueryStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetProtoRevInfoByPoolType = channel.unary_unary('/osmosis.protorev.v1beta1.Query/GetProtoRevInfoByPoolType', request_serializer=osmosis_dot_protorev_dot_v1beta1_dot_query__pb2.QueryGetProtoRevInfoByPoolTypeRequest.SerializeToString, response_deserializer=osmosis_dot_protorev_dot_v1beta1_dot_query__pb2.QueryGetProtoRevInfoByPoolTypeResponse.FromString)
        ...
        self.GetAllProtocolRevenue = channel.unary_unary('/osmosis.protorev.v1beta1.Query/GetAllProtocolRevenue', request_serializer=osmosis_dot_protorev_dot_v1beta1_dot_query__pb2.QueryGetAllProtocolRevenueRequest.SerializeToString, response_deserializer=osmosis_dot_protorev_dot_v1beta1_dot_query__pb2.QueryGetAllProtocolRevenueResponse.FromString)
...
class QueryServicer(object):
    ...
    def GetProtoRevInfoByPoolType(self, request, context):
    ...
    def GetAllProtocolRevenue(self, request, context):
...
class Query(object):
    ...
    @staticmethod
    def GetProtoRevInfoByPoolType(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/osmosis.protorev.v1beta1.Query/GetProtoRevInfoByPoolType', osmosis_dot_protorev_dot_v1beta1_dot_query__pb2.QueryGetProtoRevInfoByPoolTypeRequest.SerializeToString, osmosis_dot_protorev_dot_v1beta1_dot_query__pb2.QueryGetProtoRevInfoByPoolTypeResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    @staticmethod
    def GetAllProtocolRevenue(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/osmosis.protorev.v1beta1.Query/GetAllProtocolRevenue', osmosis_dot_protorev_dot_v1beta1_dot_query__pb2.QueryGetAllProtocolRevenueRequest.SerializeToString, osmosis_dot_protorev_dot_v1beta1_dot_query__pb2.QueryGetAllProtocolRevenueResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
...
class QueryStub(object):
    ...
    def __init__(self, channel):
        ...
        self.BeforeSendHookAddress = channel.unary_unary('/osmosis.tokenfactory.v1beta1.Query/BeforeSendHookAddress', request_serializer=osmosis_dot_tokenfactory_dot_v1beta1_dot_query__pb2.QueryBeforeSendHookAddressRequest.SerializeToString, response_deserializer=osmosis_dot_tokenfactory_dot_v1beta1_dot_query__pb2.QueryBeforeSendHookAddressResponse.FromString)
...
class Query(object):
    ...
    @staticmethod
    def BeforeSendHookAddress(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/osmosis.tokenfactory.v1beta1.Query/BeforeSendHookAddress', osmosis_dot_tokenfactory_dot_v1beta1_dot_query__pb2.QueryBeforeSendHookAddressRequest.SerializeToString, osmosis_dot_tokenfactory_dot_v1beta1_dot_query__pb2.QueryBeforeSendHookAddressResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
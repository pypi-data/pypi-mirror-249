...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _QUERYBEFORESENDHOOKADDRESSREQUEST.fields_by_name['denom']._serialized_options = b'\xf2\xde\x1f\x0cyaml:"denom"'
    _QUERYBEFORESENDHOOKADDRESSRESPONSE.fields_by_name['cosmwasm_address']._options = None
    _QUERYBEFORESENDHOOKADDRESSRESPONSE.fields_by_name['cosmwasm_address']._serialized_options = b'\xf2\xde\x1f\x17yaml:"cosmwasm_address"'
    ...
    _QUERY.methods_by_name['BeforeSendHookAddress']._serialized_options = b'\x82\xd3\xe4\x93\x02?\x12=/osmosis/tokenfactory/v1beta1/denoms/{denom}/before_send_hook'

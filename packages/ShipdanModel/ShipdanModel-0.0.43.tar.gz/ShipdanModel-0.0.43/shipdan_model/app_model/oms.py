...
class FoodProductOrderLimit(models.Model):
    ...
    validated_at = models.DateTimeField(
        help_text='해당 상품의 유통기한입니다. 생산날짜와 FoodProduct의 expiration_day로 자동으로 기입됩니다.',
        null=True,
        default=None
    )
...
class FoodProductStock(models.Model):
    ...
    safety_stock = models.IntegerField(help_text='안전재고. 해당 값보다 아래면 is_available을 False 처리합니다.')
    proper_stock = models.IntegerField(help_text='적정재고. 해당 값보다 아래면 alarm을 합니다.')

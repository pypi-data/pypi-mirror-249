# Generated by Django 4.2.3 on 2024-01-03 18:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('stock', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sabang_logs', to='app_model.foodproductstock')),
            ],
        ),
        migrations.AddField(

...
class BillingRecipt(models.Model):
    ...
    option = models.CharField(max_length=60, choices=OPTION, null=True)
...
class ContactResponse(models.Model):
    ...
    def save(self, *args, **kwargs):
        self.message = caption_optimizer(self.message)
        super(ContactResponse, self).save(*args, **kwargs)
...
class Resource(models.Model):
    ...
    TYPE = (
        ...
        ('books', _('Books')),
        ('manuals', _('Manuals')),
        ('excel_tables', _('Exel Tables')),
    )
    type = models.CharField(max_length=50, choices=TYPE, null=True, verbose_name=_('Type'), blank=True, default='')
    status = models.CharField(max_length=10, choices=STATUS, null=True, verbose_name=_('Status'), blank=True, default='Draft')

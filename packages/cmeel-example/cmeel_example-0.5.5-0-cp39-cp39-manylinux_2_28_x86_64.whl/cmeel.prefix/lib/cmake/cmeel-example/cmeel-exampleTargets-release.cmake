...
set_target_properties(cmeel-example::cmeel-example PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libcmeel-example.so.0.5.5"
  IMPORTED_SONAME_RELEASE "libcmeel-example.so.0.5.5"
  )

list(APPEND _cmake_import_check_targets cmeel-example::cmeel-example )
list(APPEND _cmake_import_check_files_for_cmeel-example::cmeel-example "${_IMPORT_PREFIX}/lib/libcmeel-example.so.0.5.5" )

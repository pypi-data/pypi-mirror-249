...
class AssistedClient(object):
    ...
    def set_default_values(self, overrides, existing=False, quiet=False):
        ...
        if 'disconnected_url' in overrides and 'installconfig' not in overrides:
            url = overrides['disconnected_url']
            disconnected_registries = [{'mirrors': [f"{url}/openshift/release", f"{url}/openshift/release-images"],
                                        "source": "quay.io/openshift-release-dev/ocp-release"},
                                       {'mirrors': [f"{url}/openshift/release", f"{url}/openshift/release-images"],
                                        "source": "quay.io/openshift-release-dev/ocp-v4.0-art-dev"}]

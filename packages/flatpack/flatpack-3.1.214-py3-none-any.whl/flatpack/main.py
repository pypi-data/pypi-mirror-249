...
async def process_depth_map(file: UploadFile = File(...), pose_data: str = Form(...),
    ...
    try:
        ...
        if pose_data:
            ...
            intrinsic_matrix = get_intrinsic_matrix(512, 512, 60)  # Example values
        ...
        return JSONResponse(content={"objects": object_details})
    except Exception as e:
        return JSONResponse(status_code=500, content={"message": str(e)})


def get_intrinsic_matrix(width, height, fov_degrees):

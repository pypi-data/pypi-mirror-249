...
from protocols.protocol_8_0.cva import PedigreeInjectRD, CancerParticipantInject, VariantsCoordinates, Transaction, \
    TransactionStatus, EvidenceEntryAndVariants
from protocols.protocol_8_0.participant import Penetrance
from protocols.protocol_8_0.reports import Assembly, EvidenceEntry, Property, EvidenceSource, Actions, Therapy, \
    DrugResponse, GenomicFeature, FeatureTypes, VariantCoordinates, DrugResponseClassification, Program

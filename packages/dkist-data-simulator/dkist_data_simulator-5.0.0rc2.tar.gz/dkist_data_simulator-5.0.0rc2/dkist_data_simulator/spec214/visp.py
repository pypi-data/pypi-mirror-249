...
class BaseVISPDataset(Spec214Dataset):
    ...
    def __init__(
        ...
        *,
        ...
        if n_stokes > 1:
            ...
            VSPPOLMD = "observe_polarimetric"
        else:
            VSPPOLMD = "observe_intensity"
    ...
    def update_polarimetric_keys(self) -> None:
        """
        ...
        if self.n_stokes > 1:
            ...
            self.add_constant_key("VSPPOLMD", "observe_intensity")

...
'''
	import apoplast.shows.ingredient_scan_essential_nutrients_recipe.formulate as formulate_essential_nutrients_recipe
	essential_nutrients_recipe = formulate_essential_nutrients_recipe.adroitly ([
		[ nature_1, amount_1 ],
		[ nature_2, amount_2 ]
	])
'''

...
DATABASE_MYSQL_PYTHON_GENERIC_CRUD_COMPONENT_NAME = 'circles_local_database_python\\generic_mapping'  # noqa E501
...
class GenericMapping(GenericCRUD):
    ...
    def insert_mapping(self, entity_name1: str, entity_name2: str, entity_id1: int, entity_id2: int) -> int:  # noqa E501
    ...
    def delete_mapping_by_id(self, entity_name1: str, entity_name2: str, entity_id1: int, entity_id2: int) -> None:   # noqa E501
    ...
    def select_multi_mapping_tupel_by_id(self, entity_name1: str,
                                         ...
                                         entity_id2: int, select_clause_value: str = "*") -> list:  # noqa501
        ...
        try:
            ...
            result = [tuple(str(value) if isinstance(
                value, datetime.datetime) else value for value in row) for row in result]  # noqa501
    ...
    def select_multi_mapping_dict_by_id(self, entity_name1: str,
        ...
        try:
            result = self.select_multi_mapping_tupel_by_id(entity_name1=entity_name1, entity_name2=entity_name2,  # noqa501
                                                           entity_id1=entity_id1, entity_id2=entity_id2, select_clause_value=select_clause_value)  # noqa501
            result = [dict(
                zip([column[0] for column in self.cursor.description()], row)) for row in result]  # noqa501
        except Exception as e:

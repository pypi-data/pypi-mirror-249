...
class Client(_client.Client):
    ...
    def applicationmigration_connect(self, route: str, output_file: typing.BinaryIO | None = None):
        return self.request(
            service='applicationmigration',
            method=_client.HttpMethod.CONNECT,
            route=route,
            body=None,
            output_file=output_file,
    ...
    def applicationmigration_delete(self, route: str, output_file: typing.BinaryIO | None = None):
        return self.request(
            service='applicationmigration',
            method=_client.HttpMethod.DELETE,
            route=route,
    ...
    def applicationmigration_get(self, route: str, output_file: typing.BinaryIO | None = None):
        return self.request(
            service='applicationmigration',
            method=_client.HttpMethod.GET,
            route=route,
    ...
    def applicationmigration_head(self, route: str, output_file: typing.BinaryIO | None = None):
        return self.request(
            service='applicationmigration',
            method=_client.HttpMethod.HEAD,
            route=route,
    ...
    def applicationmigration_options(self, route: str, output_file: typing.BinaryIO | None = None):
        return self.request(
            service='applicationmigration',
            method=_client.HttpMethod.OPTIONS,
            route=route,
    ...
    def applicationmigration_patch(
        self,
        route: str,
        body: _helpers.JsonValue | bytes,
        output_file: typing.BinaryIO | None = None,
    ...
    def applicationmigration_trace(self, route: str, output_file: typing.BinaryIO | None = None):
        return self.request(
            service='applicationmigration',
            method=_client.HttpMethod.TRACE,
            route=route,
    ...
    def em_warehouse_connect(self, route: str, output_file: typing.BinaryIO | None = None):
        return self.request(
            service='em_warehouse',
            method=_client.HttpMethod.CONNECT,
            route=route,
            body=None,
            output_file=output_file,
    ...
    def em_warehouse_delete(self, route: str, output_file: typing.BinaryIO | None = None):
        return self.request(
            service='em_warehouse',
            method=_client.HttpMethod.DELETE,
            route=route,
    ...
    def em_warehouse_get(self, route: str, output_file: typing.BinaryIO | None = None):
        return self.request(
            service='em_warehouse',
            method=_client.HttpMethod.GET,
            route=route,
    ...
    def em_warehouse_head(self, route: str, output_file: typing.BinaryIO | None = None):
        return self.request(
            service='em_warehouse',
            method=_client.HttpMethod.HEAD,
            route=route,
    ...
    def em_warehouse_options(self, route: str, output_file: typing.BinaryIO | None = None):
        return self.request(
            service='em_warehouse',
            method=_client.HttpMethod.OPTIONS,
            route=route,
    ...
    def em_warehouse_trace(self, route: str, output_file: typing.BinaryIO | None = None):
        return self.request(
            service='em_warehouse',
            method=_client.HttpMethod.TRACE,
            route=route,
    ...
    def redis_connect(self, route: str, output_file: typing.BinaryIO | None = None):
        return self.request(
            service='redis',
            method=_client.HttpMethod.CONNECT,
            route=route,
    ...
    def redis_delete(self, route: str, output_file: typing.BinaryIO | None = None):
        return self.request(
            service='redis',
            method=_client.HttpMethod.DELETE,
            route=route,
    ...
    def redis_get(self, route: str, output_file: typing.BinaryIO | None = None):
        return self.request(
            service='redis',
            method=_client.HttpMethod.GET,
            route=route,
    ...
    def redis_head(self, route: str, output_file: typing.BinaryIO | None = None):
        return self.request(
            service='redis',
            method=_client.HttpMethod.HEAD,
            route=route,
    ...
    def redis_options(self, route: str, output_file: typing.BinaryIO | None = None):
        return self.request(
            service='redis',
            method=_client.HttpMethod.OPTIONS,
            route=route,
    ...
    def redis_trace(self, route: str, output_file: typing.BinaryIO | None = None):
        return self.request(
            service='redis',
            method=_client.HttpMethod.TRACE,
            route=route,

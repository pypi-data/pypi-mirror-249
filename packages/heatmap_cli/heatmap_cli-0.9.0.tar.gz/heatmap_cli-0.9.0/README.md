...
optional arguments:
  ...
  -wk WEEK, --week WEEK
      filter until week of the year from the CSV file (default: '01')
  ...
  -cmin COLORMAP_MIN_VALUE, --cmap-min-value COLORMAP_MIN_VALUE
      set the minimum value of the colormap range (default: 'False')
  -cmax COLORMAP_MAX_VALUE, --cmap-max-value COLORMAP_MAX_VALUE

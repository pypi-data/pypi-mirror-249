import warnings
from typing import Union, Collection, List, Dict, Optional, Callable
...
def __local_execution_disabled():
    raise Exception(
        """This is a stub that only contains the interfaces to Delta Live Tables. 
        Delta Live Tables pipelines cannot be run locally. To learn more, please visit 
...
def table(query_function: Optional[Callable] = None,
...
def view(query_function: Optional[Callable] = None,
         name: Optional[str] = None,
         comment: Optional[str] = None,
         spark_conf: Optional[Dict[str, str]] = None):
    """
...
def expect_all_or_fail(expectations: Dict[str, Union[str, Column]]):
    """
...
def expect_all_or_drop(expectations: Dict[str, Union[str, Column]]):
    """
...
def expect(name: str, inv: Union[str, Column]):
    """
...
def expect_or_fail(name: str, inv: Union[str, Column]):
    """
...
def expect_or_drop(name: str, inv: Union[str, Column]):
    """

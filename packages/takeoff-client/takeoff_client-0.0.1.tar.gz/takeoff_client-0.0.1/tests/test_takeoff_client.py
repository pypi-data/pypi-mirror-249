...
class TestTakeoffClient:
    ...
    def test_get_readers(self):
        mock_response = {'primary': [{'reader_id': 'test', 'backend': 'test', 'model_name': 'test', 'model_type': 'test', 'pids': [0], 'ready': True}]}
    ...
    def test_generate_stream_success(self, mock_response):
        ...
        with patch('requests.post', return_value=mock_response) as mock_post:
            ...
            # Action
            result_generator = instance.generate_stream(text_batch)
    ...
    def test_generate_stream_failure(self, mock_response):
        ...
        with patch('requests.post', return_value=mock_response):
            ...
            with pytest.raises(Exception) as excinfo:
                _ = list(instance.generate_stream(text_batch))

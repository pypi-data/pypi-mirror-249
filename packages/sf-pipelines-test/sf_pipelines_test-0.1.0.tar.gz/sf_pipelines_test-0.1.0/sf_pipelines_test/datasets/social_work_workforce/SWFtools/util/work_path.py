import sys
import os
import sf_pipelines_test.datasets.social_work_workforce.SWFtools.util.AppLogs as AppLogs

# Setting the paths to work and executing and using the scripts

# Define filepaths
main_folder = r"/workspaces/liia-tools/sf_pipelines_test/spec/social_work_workforce"

...
from sf_pipelines_test.common.stream_filters import inherit_property as __inherit_property
from sf_pipelines_test.datasets.shared_functions.converters import (
...
def check_postcode(*args, **kwargs):
    warn(
        "This function is deprecated. Use sf_pipelines_test.datasets.shared_functions.converters.check_postcode instead.",
        DeprecationWarning,
    )
...
def inherit_property(stream, prop_name: Union[str, Iterable[str]], override=False):
    warn(
        "This function is deprecated. Use sf_pipelines_test.datasets.shared_functions.stream.inherit_property instead.",
        DeprecationWarning,
    )

...
from sf_pipelines_test.datasets.annex_a.lds_annexa_clean import cleaner
from sf_pipelines_test.datasets.annex_a.lds_annexa_clean import configuration as clean_config
from sf_pipelines_test.datasets.annex_a.lds_annexa_clean import (
    degrade,
    file_creator,
    logger,
    populate,
)
from sf_pipelines_test.datasets.annex_a.lds_annexa_la_agg import configuration as agg_config
from sf_pipelines_test.datasets.annex_a.lds_annexa_la_agg import process as agg_process
from sf_pipelines_test.datasets.annex_a.lds_annexa_pan_agg import configuration as pan_config
from sf_pipelines_test.datasets.annex_a.lds_annexa_pan_agg import process as pan_process

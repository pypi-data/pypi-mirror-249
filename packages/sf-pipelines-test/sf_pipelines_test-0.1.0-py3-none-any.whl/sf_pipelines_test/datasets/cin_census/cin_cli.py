...
from sf_pipelines_test.common.reference import authorities
from sf_pipelines_test.datasets.cin_census.lds_cin_clean import cin_record
from sf_pipelines_test.datasets.cin_census.lds_cin_clean import configuration as clean_config
from sf_pipelines_test.datasets.cin_census.lds_cin_clean import (
    converter,
    file_creator,
    filters,
    logger,
...
from sf_pipelines_test.datasets.cin_census.lds_cin_clean.parse import dom_parse
from sf_pipelines_test.datasets.cin_census.lds_cin_clean.schema import Schema

# Dependencies for la_agg()
from sf_pipelines_test.datasets.cin_census.lds_cin_la_agg import configuration as agg_config
from sf_pipelines_test.datasets.cin_census.lds_cin_la_agg import process as agg_process

# Dependencies for pan_agg()
from sf_pipelines_test.datasets.cin_census.lds_cin_pan_agg import configuration as pan_config
from sf_pipelines_test.datasets.cin_census.lds_cin_pan_agg import process as pan_process
from sf_pipelines_test.datasets.shared_functions.common import (
    check_file_type,
    check_year,

...
class ChatGPT:
    ...
    def run(self, prompt=""):
        ...
        while True:
            if not prompt:
                prompt = HealthCheck.simplePrompt(style=promptStyle, promptSession=chat_session, completer=completer, custom_key_bindings=custom_key_bindings)
                ...
                prompt = HealthCheck.simplePrompt(style=promptStyle, promptSession=chat_session, completer=completer, custom_key_bindings=custom_key_bindings, custom_key_bindings=custom_key_bindings, default=prompt)

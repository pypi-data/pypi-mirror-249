...
from aos_prov.commands.command_vm_multi_node_manage import new_vms, start_vms, remove_vms_in_group, check_run_states_of_vms
...
def start_check_vm_unit(name: str) -> None:
    """Start checking all VMs in the group are running.

    Args:
        name (str): Name of the group to start without root AosUnits group.
    """
    check_run_states_of_vms(name)

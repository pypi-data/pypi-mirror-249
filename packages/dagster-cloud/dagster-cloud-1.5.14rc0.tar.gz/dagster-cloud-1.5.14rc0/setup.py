...
setup(
    ...
    extras_require={
        "tests": [
            ...
            "dbt-postgres",
            "dbt-duckdb",
            "dagster-dbt==0.21.14rc0",
            "dagster_k8s==0.21.14rc0",
        ],
        "docker": ["docker", "dagster_docker==0.21.14rc0"],
        "kubernetes": ["kubernetes", "dagster_k8s==0.21.14rc0"],
        "ecs": ["dagster_aws==0.21.14rc0", "boto3"],
        "sandbox": ["supervisor"],
        "pex": ["boto3"],
        "serverless": ["boto3"],
    },

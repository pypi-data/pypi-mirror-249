        ...
        try:
            ...
            for i in all_vaults:
                ...
                for original_data in _data: 
                    if original_data['vault'] == f'{i}' and 'last_use' in original_data[f'{i}']:
                        vault_dict['last_use'] = original_data[f'{i}']['last_use']
                    elif original_data['vault'] == f'{i}' and 'total_use' in original_data:
                        vault_dict['total_use'] = original_data[f'{i}']['total_use']

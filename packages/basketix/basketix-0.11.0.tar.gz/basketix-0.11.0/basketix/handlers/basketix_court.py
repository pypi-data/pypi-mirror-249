...
class BasketixCourtHandler:
    ...
    def default(self) -> BasketballCourtSettings:
        return {
            "background_color": self.DEFAULT_COURT_COLOR,
            "court_color": self.DEFAULT_COURT_COLOR,
            "lines_color": self.BLACK,
            "lines_width": self.DEFAULT_LINE_WIDTH,
            "paint_color": self.DEFAULT_COURT_COLOR,
            "side_paint_color": self.DEFAULT_COURT_COLOR,
            "three_points_color": self.DEFAULT_COURT_COLOR,
        }

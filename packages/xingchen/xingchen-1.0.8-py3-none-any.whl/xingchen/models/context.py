...
class Context(BaseModel):
    ...
    reply_message_id: Optional[StrictStr] = Field(None, alias="replyMessageId")
    ...
    __properties = ["chatRoomId", "sessionId", "chatId", "messageId", "replyMessageId", "enableDataInspection", "isSave", "requestId", "modelRequestId", "characterPk", "modelName"]

![Symfem](https://raw.githubusercontent.com/mscroggs/symfem/v2024.1.1/logo/logo.png)
...
You can find details of recent changes to Symfem in [the changelog](https://raw.githubusercontent.com/mscroggs/symfem/v2024.1.1/CHANGELOG.md).
...
[`symfem.calculus`](https://raw.githubusercontent.com/mscroggs/symfem/v2024.1.1/symfem/calculus.py). Vector-valued basis functions can
be manipulated using the functions in [`symfem.vector`](https://raw.githubusercontent.com/mscroggs/symfem/v2024.1.1/symfem/vectors.py).
...
of Symfem can be found in the [`demo` folder](https://raw.githubusercontent.com/mscroggs/symfem/v2024.1.1/demo/) or viewed on
...
If you want to add a new element to Symfem, take a look at the [Adding an element guide](https://raw.githubusercontent.com/mscroggs/symfem/v2024.1.1/ADDING_AN_ELEMENT.md).
...
## Code of conduct
We expect all our contributors to follow [the Contributor Covenant](https://raw.githubusercontent.com/mscroggs/symfem/v2024.1.1/CODE_OF_CONDUCT.md). Any unacceptable
...
![The numbering of a reference interval](https://raw.githubusercontent.com/mscroggs/symfem/v2024.1.1/img/interval_numbering.png)
...
![The numbering of a reference triangle](https://raw.githubusercontent.com/mscroggs/symfem/v2024.1.1/img/triangle_numbering.png)
...
![The numbering of a reference quadrilateral](https://raw.githubusercontent.com/mscroggs/symfem/v2024.1.1/img/quadrilateral_numbering.png)
...
![The numbering of a reference tetrahedron](https://raw.githubusercontent.com/mscroggs/symfem/v2024.1.1/img/tetrahedron_numbering.png)
...
![The numbering of a reference hexahedron](https://raw.githubusercontent.com/mscroggs/symfem/v2024.1.1/img/hexahedron_numbering.png)
...
![The numbering of a reference prism](https://raw.githubusercontent.com/mscroggs/symfem/v2024.1.1/img/prism_numbering.png)
...
![The numbering of a reference pyramid](https://raw.githubusercontent.com/mscroggs/symfem/v2024.1.1/img/pyramid_numbering.png)
...
![The numbering of a reference dual polygon](https://raw.githubusercontent.com/mscroggs/symfem/v2024.1.1/img/dual_polygon_numbering.png)

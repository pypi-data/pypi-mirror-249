...
_GETCOMMITSIGNATURESRESPONSE_SIGNER = _descriptor.EnumDescriptor(
  name='Signer',
  full_name='gitaly.GetCommitSignaturesResponse.Signer',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='SIGNER_USER', index=1, number=1,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='SIGNER_SYSTEM', index=2, number=2,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_sym_db.RegisterEnumDescriptor(_GETCOMMITSIGNATURESRESPONSE_SIGNER)
...
_GETTREEENTRIESERROR = _descriptor.Descriptor(
  name='GetTreeEntriesError',
  full_name='gitaly.GetTreeEntriesError',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='resolve_tree', full_name='gitaly.GetTreeEntriesError.resolve_tree', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='path', full_name='gitaly.GetTreeEntriesError.path', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='error', full_name='gitaly.GetTreeEntriesError.error',
...
_GETCOMMITSIGNATURESRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='signer', full_name='gitaly.GetCommitSignaturesResponse.signer', index=3,
      number=4, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[],
  enum_types=[
    _GETCOMMITSIGNATURESRESPONSE_SIGNER,
  ],
  serialized_options=None,
  is_extendable=False,
  syntax='proto3',
...
_GETTREEENTRIESERROR.fields_by_name['resolve_tree'].message_type = errors__pb2._RESOLVEREVISIONERROR
_GETTREEENTRIESERROR.fields_by_name['path'].message_type = errors__pb2._PATHERROR
_GETTREEENTRIESERROR.oneofs_by_name['error'].fields.append(
  _GETTREEENTRIESERROR.fields_by_name['resolve_tree'])
_GETTREEENTRIESERROR.fields_by_name['resolve_tree'].containing_oneof = _GETTREEENTRIESERROR.oneofs_by_name['error']
_GETTREEENTRIESERROR.oneofs_by_name['error'].fields.append(
  _GETTREEENTRIESERROR.fields_by_name['path'])
_GETTREEENTRIESERROR.fields_by_name['path'].containing_oneof = _GETTREEENTRIESERROR.oneofs_by_name['error']
...
_GETCOMMITSIGNATURESRESPONSE.fields_by_name['signer'].enum_type = _GETCOMMITSIGNATURESRESPONSE_SIGNER
_GETCOMMITSIGNATURESRESPONSE_SIGNER.containing_type = _GETCOMMITSIGNATURESRESPONSE
...
DESCRIPTOR.message_types_by_name['GetTreeEntriesError'] = _GETTREEENTRIESERROR
...
GetTreeEntriesError = _reflection.GeneratedProtocolMessageType('GetTreeEntriesError', (_message.Message,), {
  'DESCRIPTOR' : _GETTREEENTRIESERROR,
  '__module__' : 'commit_pb2'
  # @@protoc_insertion_point(class_scope:gitaly.GetTreeEntriesError)
  })
_sym_db.RegisterMessage(GetTreeEntriesError)

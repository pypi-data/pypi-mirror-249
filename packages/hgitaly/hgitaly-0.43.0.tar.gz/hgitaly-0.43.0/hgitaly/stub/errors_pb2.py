...
_PATHERROR_ERRORTYPE = _descriptor.EnumDescriptor(
  name='ErrorType',
  full_name='gitaly.PathError.ErrorType',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='ERROR_TYPE_RELATIVE_PATH_ESCAPES_REPOSITORY', index=2, number=2,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='ERROR_TYPE_ABSOLUTE_PATH', index=3, number=3,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='ERROR_TYPE_LONG_PATH', index=4, number=4,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_sym_db.RegisterEnumDescriptor(_PATHERROR_ERRORTYPE)
...
_REFERENCESTATEMISMATCHERROR = _descriptor.Descriptor(
  name='ReferenceStateMismatchError',
  full_name='gitaly.ReferenceStateMismatchError',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='reference_name', full_name='gitaly.ReferenceStateMismatchError.reference_name', index=0,
      number=1, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=b"",
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='expected_object_id', full_name='gitaly.ReferenceStateMismatchError.expected_object_id', index=1,
      number=2, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=b"",
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='actual_object_id', full_name='gitaly.ReferenceStateMismatchError.actual_object_id', index=2,
...
_PATHERROR = _descriptor.Descriptor(
  name='PathError',
  full_name='gitaly.PathError',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='path', full_name='gitaly.PathError.path', index=0,
      number=1, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=b"",
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='error_type', full_name='gitaly.PathError.error_type', index=1,
      number=2, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PATHERROR.fields_by_name['error_type'].enum_type = _PATHERROR_ERRORTYPE
_PATHERROR_ERRORTYPE.containing_type = _PATHERROR
...
DESCRIPTOR.message_types_by_name['ReferenceStateMismatchError'] = _REFERENCESTATEMISMATCHERROR
...
DESCRIPTOR.message_types_by_name['PathError'] = _PATHERROR
...
ReferenceStateMismatchError = _reflection.GeneratedProtocolMessageType('ReferenceStateMismatchError', (_message.Message,), {
  'DESCRIPTOR' : _REFERENCESTATEMISMATCHERROR,
  '__module__' : 'errors_pb2'
  # @@protoc_insertion_point(class_scope:gitaly.ReferenceStateMismatchError)
  })
_sym_db.RegisterMessage(ReferenceStateMismatchError)
...
PathError = _reflection.GeneratedProtocolMessageType('PathError', (_message.Message,), {
  'DESCRIPTOR' : _PATHERROR,
  '__module__' : 'errors_pb2'
  # @@protoc_insertion_point(class_scope:gitaly.PathError)
  })
_sym_db.RegisterMessage(PathError)

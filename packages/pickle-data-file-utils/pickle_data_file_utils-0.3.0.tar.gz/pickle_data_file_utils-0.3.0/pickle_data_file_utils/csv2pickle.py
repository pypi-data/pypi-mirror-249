...
from pickle_data_file_utils.helper import csv_to_pickle
...
@click.command()
@click.option('--infile', help="Required: The comma-separated input file")
...
def main(infile: str, logfile: str, outdir: str, outfile: str, verbose: bool):
    """Convert comma-separated file to pickle file."""
    error_ctr = 0

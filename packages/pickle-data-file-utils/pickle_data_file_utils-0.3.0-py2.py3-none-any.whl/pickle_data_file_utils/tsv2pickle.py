...
from pickle_data_file_utils.helper import tsv_to_pickle
...
@click.command()
@click.option('--infile', help="Required: The input tab-delimited file")
...
def main(infile: str, logfile: str, outdir: str, outfile: str, verbose: bool):
    """Convert tab-delimited file to pickle file."""
    error_ctr = 0

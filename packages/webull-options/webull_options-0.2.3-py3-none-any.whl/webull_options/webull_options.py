...
class WebullOptions:
    def __init__(self, access_token, osv, did):
        ...
        self.osv = osv
        self.did = did
        self.opts = PolygonOptions(user='postgres', database='fudstop')
        ...
        self.headers =  { 
            ...
            "Hl": "en",
            "Os": "web"}
        self.sync_db_params = {'database': 'fudstop', 'user': 'postgres', 'password': 'fud', 'host': 'localhost'}
        self.db_manager = DBManager(host='localhost', user='postgres', password='fud', database='fudstop', port=5432)

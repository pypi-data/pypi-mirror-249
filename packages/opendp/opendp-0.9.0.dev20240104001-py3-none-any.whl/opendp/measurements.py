...
def make_alp_queryable(
    ...
    [make_alp_queryable in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/measurements/fn.make_alp_queryable.html)
...
def then_alp_queryable(
    ...
    r"""make_alp_queryable's partial constructor.
...
def make_base_discrete_gaussian(
    ...
    [make_base_discrete_gaussian in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/measurements/fn.make_base_discrete_gaussian.html)
...
def then_base_discrete_gaussian(
    ...
    r"""make_base_discrete_gaussian's partial constructor.
...
def make_base_discrete_laplace(
    ...
    [make_base_discrete_laplace in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/measurements/fn.make_base_discrete_laplace.html)
...
def then_base_discrete_laplace(
    ...
    r"""make_base_discrete_laplace's partial constructor.
...
def make_base_discrete_laplace_cks20(
    ...
    [make_base_discrete_laplace_cks20 in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/measurements/fn.make_base_discrete_laplace_cks20.html)
...
def then_base_discrete_laplace_cks20(
    ...
    r"""make_base_discrete_laplace_cks20's partial constructor.
...
def make_base_discrete_laplace_linear(
    ...
    [make_base_discrete_laplace_linear in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/measurements/fn.make_base_discrete_laplace_linear.html)
...
def then_base_discrete_laplace_linear(
    ...
    r"""make_base_discrete_laplace_linear's partial constructor.
...
def make_base_gaussian(
    ...
    [make_base_gaussian in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/measurements/fn.make_base_gaussian.html)
...
def then_base_gaussian(
    ...
    r"""make_base_gaussian's partial constructor.
...
def make_base_geometric(
    ...
    [make_base_geometric in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/measurements/fn.make_base_geometric.html)
...
def then_base_geometric(
    ...
    r"""make_base_geometric's partial constructor.
...
def make_base_laplace(
    ...
    [make_base_laplace in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/measurements/fn.make_base_laplace.html)
...
def then_base_laplace(
    ...
    r"""make_base_laplace's partial constructor.
...
def make_base_laplace_threshold(
    ...
    [make_base_laplace_threshold in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/measurements/fn.make_base_laplace_threshold.html)
...
def then_base_laplace_threshold(
    ...
    r"""make_base_laplace_threshold's partial constructor.
...
def make_gaussian(
    ...
    [make_gaussian in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/measurements/fn.make_gaussian.html)
...
def then_gaussian(
    ...
    r"""make_gaussian's partial constructor.
...
def make_laplace(
    ...
    [make_laplace in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/measurements/fn.make_laplace.html)
...
def then_laplace(
    ...
    r"""make_laplace's partial constructor.
...
def make_randomized_response(
    ...
    [make_randomized_response in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/measurements/fn.make_randomized_response.html)
...
def make_randomized_response_bool(
    ...
    [make_randomized_response_bool in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/measurements/fn.make_randomized_response_bool.html)
...
def make_report_noisy_max_gumbel(
    ...
    [make_report_noisy_max_gumbel in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/measurements/fn.make_report_noisy_max_gumbel.html)
...
def then_report_noisy_max_gumbel(
    ...
    r"""make_report_noisy_max_gumbel's partial constructor.
...
def make_user_measurement(
    ...
    [make_user_measurement in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/measurements/fn.make_user_measurement.html)
...
def then_user_measurement(
    ...
    r"""make_user_measurement's partial constructor.

...
def _measure_free(
    ...
    [_measure_free in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/measures/fn._measure_free.html)
...
def fixed_smoothed_max_divergence(
    ...
    [fixed_smoothed_max_divergence in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/measures/fn.fixed_smoothed_max_divergence.html)
...
def max_divergence(
    ...
    [max_divergence in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/measures/fn.max_divergence.html)
...
def measure_debug(
    ...
    [measure_debug in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/measures/fn.measure_debug.html)
...
def measure_distance_type(
    ...
    [measure_distance_type in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/measures/fn.measure_distance_type.html)
...
def measure_type(
    ...
    [measure_type in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/measures/fn.measure_type.html)
...
def smoothed_max_divergence(
    ...
    [smoothed_max_divergence in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/measures/fn.smoothed_max_divergence.html)
...
def user_divergence(
    ...
    [user_divergence in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/measures/fn.user_divergence.html)
...
def zero_concentrated_divergence(
    ...
    [zero_concentrated_divergence in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/measures/fn.zero_concentrated_divergence.html)

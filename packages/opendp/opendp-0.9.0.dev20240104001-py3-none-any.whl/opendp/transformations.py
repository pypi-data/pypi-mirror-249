...
def choose_branching_factor(
    ...
    [choose_branching_factor in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.choose_branching_factor.html)
...
def make_b_ary_tree(
    ...
    [make_b_ary_tree in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_b_ary_tree.html)
...
def then_b_ary_tree(
    ...
    r"""make_b_ary_tree's partial constructor.
...
def make_bounded_float_checked_sum(
    ...
    [make_bounded_float_checked_sum in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_bounded_float_checked_sum.html)
...
def make_bounded_float_ordered_sum(
    ...
    [make_bounded_float_ordered_sum in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_bounded_float_ordered_sum.html)
...
def make_bounded_int_monotonic_sum(
    ...
    [make_bounded_int_monotonic_sum in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_bounded_int_monotonic_sum.html)
...
def make_bounded_int_ordered_sum(
    ...
    [make_bounded_int_ordered_sum in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_bounded_int_ordered_sum.html)
...
def make_bounded_int_split_sum(
    ...
    [make_bounded_int_split_sum in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_bounded_int_split_sum.html)
...
def make_cast(
    ...
    [make_cast in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_cast.html)
...
def then_cast(
    ...
    r"""make_cast's partial constructor.
...
def make_cast_default(
    ...
    [make_cast_default in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_cast_default.html)
...
def then_cast_default(
    ...
    r"""make_cast_default's partial constructor.
...
def make_cast_inherent(
    ...
    [make_cast_inherent in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_cast_inherent.html)
...
def then_cast_inherent(
    ...
    r"""make_cast_inherent's partial constructor.
...
def make_cdf(
    ...
    [make_cdf in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_cdf.html)
...
def make_clamp(
    ...
    [make_clamp in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_clamp.html)
...
def then_clamp(
    ...
    r"""make_clamp's partial constructor.
...
def make_consistent_b_ary_tree(
    ...
    [make_consistent_b_ary_tree in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_consistent_b_ary_tree.html)
...
def make_count(
    ...
    [make_count in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_count.html)
...
def then_count(
    ...
    r"""make_count's partial constructor.
...
def make_count_by(
    ...
    [make_count_by in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_count_by.html)
...
def then_count_by(
    ...
    r"""make_count_by's partial constructor.
...
def make_count_by_categories(
    ...
    [make_count_by_categories in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_count_by_categories.html)
...
def then_count_by_categories(
    ...
    r"""make_count_by_categories's partial constructor.
...
def make_count_distinct(
    ...
    [make_count_distinct in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_count_distinct.html)
...
def then_count_distinct(
    ...
    r"""make_count_distinct's partial constructor.
...
def make_create_dataframe(
    ...
    [make_create_dataframe in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_create_dataframe.html)
...
def make_df_cast_default(
    ...
    [make_df_cast_default in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_df_cast_default.html)
...
def then_df_cast_default(
    ...
    r"""make_df_cast_default's partial constructor.
...
def make_df_is_equal(
    ...
    [make_df_is_equal in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_df_is_equal.html)
...
def then_df_is_equal(
    ...
    r"""make_df_is_equal's partial constructor.
...
def make_drop_null(
    ...
    [make_drop_null in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_drop_null.html)
...
def then_drop_null(
    ...
    r"""make_drop_null's partial constructor.
...
def make_find(
    ...
    [make_find in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_find.html)
...
def then_find(
    ...
    r"""make_find's partial constructor.
...
def make_find_bin(
    ...
    [make_find_bin in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_find_bin.html)
...
def then_find_bin(
    ...
    r"""make_find_bin's partial constructor.
...
def make_identity(
    ...
    [make_identity in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_identity.html)
...
def then_identity(
    ...
    r"""make_identity's partial constructor.
...
def make_impute_constant(
    ...
    [make_impute_constant in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_impute_constant.html)
...
def then_impute_constant(
    ...
    r"""make_impute_constant's partial constructor.
...
def make_impute_uniform_float(
    ...
    [make_impute_uniform_float in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_impute_uniform_float.html)
...
def then_impute_uniform_float(
    ...
    r"""make_impute_uniform_float's partial constructor.
...
def make_index(
    ...
    [make_index in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_index.html)
...
def then_index(
    ...
    r"""make_index's partial constructor.
...
def make_is_equal(
    ...
    [make_is_equal in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_is_equal.html)
...
def then_is_equal(
    ...
    r"""make_is_equal's partial constructor.
...
def make_is_null(
    ...
    [make_is_null in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_is_null.html)
...
def then_is_null(
    ...
    r"""make_is_null's partial constructor.
...
def make_lipschitz_float_mul(
    ...
    [make_lipschitz_float_mul in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_lipschitz_float_mul.html)
...
def make_mean(
    ...
    [make_mean in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_mean.html)
...
def then_mean(
    ...
    r"""make_mean's partial constructor.
...
def make_metric_bounded(
    ...
    [make_metric_bounded in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_metric_bounded.html)
...
def then_metric_bounded(
    ...
    r"""make_metric_bounded's partial constructor.
...
def make_metric_unbounded(
    ...
    [make_metric_unbounded in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_metric_unbounded.html)
...
def then_metric_unbounded(
    ...
    r"""make_metric_unbounded's partial constructor.
...
def make_ordered_random(
    ...
    [make_ordered_random in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_ordered_random.html)
...
def then_ordered_random(
    ...
    r"""make_ordered_random's partial constructor.
...
def make_quantile_score_candidates(
    ...
    [make_quantile_score_candidates in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_quantile_score_candidates.html)
...
def then_quantile_score_candidates(
    ...
    r"""make_quantile_score_candidates's partial constructor.
...
def make_quantiles_from_counts(
    ...
    [make_quantiles_from_counts in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_quantiles_from_counts.html)
...
def make_resize(
    ...
    [make_resize in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_resize.html)
...
def then_resize(
    ...
    r"""make_resize's partial constructor.
...
def make_select_column(
    ...
    [make_select_column in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_select_column.html)
...
def make_sized_bounded_float_checked_sum(
    ...
    [make_sized_bounded_float_checked_sum in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_sized_bounded_float_checked_sum.html)
...
def make_sized_bounded_float_ordered_sum(
    ...
    [make_sized_bounded_float_ordered_sum in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_sized_bounded_float_ordered_sum.html)
...
def make_sized_bounded_int_checked_sum(
    ...
    [make_sized_bounded_int_checked_sum in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_sized_bounded_int_checked_sum.html)
...
def make_sized_bounded_int_monotonic_sum(
    ...
    [make_sized_bounded_int_monotonic_sum in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_sized_bounded_int_monotonic_sum.html)
...
def make_sized_bounded_int_ordered_sum(
    ...
    [make_sized_bounded_int_ordered_sum in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_sized_bounded_int_ordered_sum.html)
...
def make_sized_bounded_int_split_sum(
    ...
    [make_sized_bounded_int_split_sum in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_sized_bounded_int_split_sum.html)
...
def make_split_dataframe(
    ...
    [make_split_dataframe in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_split_dataframe.html)
...
def make_split_lines(
    ...
    [make_split_lines in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_split_lines.html)
...
def make_split_records(
    ...
    [make_split_records in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_split_records.html)
...
def make_subset_by(
    ...
    [make_subset_by in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_subset_by.html)
...
def make_sum(
    ...
    [make_sum in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_sum.html)
...
def then_sum(
    ...
    r"""make_sum's partial constructor.
...
def make_sum_of_squared_deviations(
    ...
    [make_sum_of_squared_deviations in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_sum_of_squared_deviations.html)
...
def then_sum_of_squared_deviations(
    ...
    r"""make_sum_of_squared_deviations's partial constructor.
...
def make_unordered(
    ...
    [make_unordered in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_unordered.html)
...
def then_unordered(
    ...
    r"""make_unordered's partial constructor.
...
def make_user_transformation(
    ...
    [make_user_transformation in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_user_transformation.html)
...
def make_variance(
    ...
    [make_variance in Rust documentation.](https://docs.rs/opendp/0.9.0-dev.20240104.1/opendp/transformations/fn.make_variance.html)
...
def then_variance(
    ...
    r"""make_variance's partial constructor.

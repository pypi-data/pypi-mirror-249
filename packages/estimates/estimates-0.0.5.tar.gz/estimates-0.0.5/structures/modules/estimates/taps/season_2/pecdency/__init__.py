...
'''
	import estimates.taps.season_1.pecdency as pecdency_indicator
...
import estimates.taps.season_1.ATR as ATR_indicator
...
def calc (
	...
	for i in range (spans, len (places)):
		...
		place_1 ['pecdency UB'] = upper_band
		place_2 ['pecdency LB'] = lower_band

		if end > upper_band:
			place_2 ['pecdency'] = lower_band
			place_2 ['direction'] = 1  # Buy Signal
			
			print ("Buy")
			
		elif end < lower_band:
			place_2 ['pecdency'] = upper_band
			place_2 ['direction'] = -1  # Sell Signal

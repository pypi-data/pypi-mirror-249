...
from vgs.sdk.serializers import Literal, yaml  # this one correctly outputs blocks
...
def get_vaults(ctx, vault):
    ...
    # TODO: port this to the normalize method
    # when this pr is closed this can be removed https://github.com/verygoodsecurity/product/pull/704
                ...
                for operation in filter_item["operations"]:
                    if "parameters" in operation:
                        if "script" in operation["parameters"]:
                            operation["parameters"]["script"] = Literal(
                                operation["parameters"]["script"]
                            )

...
class TrackUsageRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["key", "openAiResponse", "usage", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["key", "openAiResponse", "usage", ], str]):

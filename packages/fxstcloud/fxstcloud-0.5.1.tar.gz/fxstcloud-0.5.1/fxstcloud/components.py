...
.. note::
        ...
        inherit from :class:`~FxView` instead of :class:`discord.ui.View`.

        .. code-block:: python

            from fxstcloud import View
...
class View(discord.ui.View):
    ...
    async def on_error(
        ...
        Executes all registered error handlers with the ``@fxstcloud.event`` decorator.
        """
        if not PYCORD:

...
class fxstcloudException(Exception):
    """Base exception class for all fxstcloud exceptions."""


class ConvertTimeError(fxstcloudException):
    """Raised when a time conversion fails."""


class Blacklisted(fxstcloudException):

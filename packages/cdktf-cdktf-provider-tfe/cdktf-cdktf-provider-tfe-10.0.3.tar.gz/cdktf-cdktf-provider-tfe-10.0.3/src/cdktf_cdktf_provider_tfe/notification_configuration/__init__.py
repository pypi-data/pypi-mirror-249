...
Refer to the Terraform Registory for docs: [`tfe_notification_configuration`](https://registry.terraform.io/providers/hashicorp/tfe/0.51.1/docs/resources/notification_configuration).
'''
import abc
import builtins
import datetime

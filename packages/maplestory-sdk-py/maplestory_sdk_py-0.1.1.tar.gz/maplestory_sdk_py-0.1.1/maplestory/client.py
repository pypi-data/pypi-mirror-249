...
from maplestory.errors import MapleStoryApiError, MapleStoryApiException
...
from maplestory.models.guild import Guild, GuildBasic
...
from maplestory.utils.date import get_proper_default_datetime, to_date_string
...
class MapleStoryApi(BaseModel):
    ...
    def get_character_basic(
        self,
        ocid: str,
        date: datetime = get_proper_default_datetime(update_hour=1, day_offset=1),
    ) -> CharacterBasic:
        """기본 정보를 조회합니다.
    ...
    def get_character_cashitem_equip(
        self,
        ocid: str,
        date: datetime = get_proper_default_datetime(update_hour=1, day_offset=1),
    ) -> CharacterCashitemEquipment:
    ...
    def get_character_symbol_equip(
        self,
        ocid: str,
        date: datetime = get_proper_default_datetime(update_hour=1, day_offset=1),
    ) -> CharacterSymbolEquipment:
    ...
    def get_character_beauty_equip(
        self,
        ocid: str,
        date: datetime = get_proper_default_datetime(update_hour=1, day_offset=1),
    ) -> CharacterBeautyEquipment:
    ...
    def get_character_android_equip(
        self,
        ocid: str,
        date: datetime = get_proper_default_datetime(update_hour=1, day_offset=1),
    ) -> CharacterAndroidEquipment:
    ...
    def get_character_skill(
        ...
        date: datetime = get_proper_default_datetime(day_offset=1),
    ) -> CharacterSkill:
    ...
    def get_character_link_skill(
        self, ocid: str, date: datetime = get_proper_default_datetime(day_offset=1)
    ) -> CharacterLinkSkill:
        """장착 링크 스킬 정보를 조회합니다.
    ...
    def get_cube_history(
        self, count, date: datetime | None = None, cursor: str | None = None
    ) -> CubeHistory:
        """큐브 사용 결과를 조회합니다.
    ...
    def get_overall_ranking(
        ...
        world_type: int | None = None,
        class_name: str | None = None,
        ocid: str | None = None,
        page: int = 1,
        date: datetime = get_proper_default_datetime(
            update_hour=8, update_minute=30, day_offset=0
        ),
    ) -> OverallRanking:
        """종합 랭킹 정보를 조회합니다.

...
class TestExampleWrappers2(TestCase):
    ...
    def setUp(self):
        class RelatedVisitModelWrapper1(ModelWrapper):
            model = "edc_model_wrapper.subjectvisit"
            next_url_name = "listboard_url"
            next_url_attrs = ["v1"]

        class RelatedVisitModelWrapper2(ModelWrapper):
            model = "edc_model_wrapper.subjectvisit"
            next_url_name = "listboard_url"
        ...
        class AppointmentModelWrapper1(ModelWrapper):
            ...
            def visit(self):
                ...
                return RelatedVisitModelWrapper1(model_obj=model_obj)
        ...
        class AppointmentModelWrapper2(ModelWrapper):
            ...
            def visit(self):
                model_obj = self.object.subjectvisit
                return RelatedVisitModelWrapper2(model_obj=model_obj)

        self.appointment_model_wrapper1_cls = AppointmentModelWrapper1
        self.appointment_model_wrapper2_cls = AppointmentModelWrapper2
        self.subject_visit_model_wrapper1_cls = RelatedVisitModelWrapper1
        self.subject_visit_model_wrapper2_cls = RelatedVisitModelWrapper2

...
@LastEditTime: 2023-12-25 15:31:49
...
class TopBaseModel():
    ...
    def instantiate(self, app_id, user_nick, access_token, app_key, app_secret, is_log=False, main_user_open_id='', app_name='', description='', icon="", template_id='', template_version=''):
        """
        :description: 实例化
        :param app_id:应用标识

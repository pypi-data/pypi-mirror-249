...
"""This module contains objects representing TeleGenic bot command scopes."""
...
class BotCommandScope(TeleGenicObject):
...
class BotCommandScopeDefault(BotCommandScope):
    ...
    .. _`narrower scope`: https://core.TeleGenic.org/bots/api#determining-list-of-commands

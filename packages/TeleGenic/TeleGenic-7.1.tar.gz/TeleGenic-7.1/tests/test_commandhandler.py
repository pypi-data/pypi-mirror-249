...
def is_match(handler, update):
    ...
    :param handler: ``Command`` to check against
...
class BaseTest:
    ...
    def _test_edited(self, message, handler_edited, handler_not_edited):
        ...
        :param message: ``TeleGenic.Message`` to check against the handlers
...
class TestCommand(BaseTest):
    ...
    def test_deprecation_warning(self):
        ...
        with pytest.warns(TeleGenicDeprecationWarning, match='See https://git.io/fxJuV'):

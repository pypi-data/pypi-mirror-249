...
from TeleGenic import OrderInfo, SuccessfulPayment
...
def successful_payment():
    return SuccessfulPayment(
        ...
        TestSuccessfulPayment.TeleGenic_payment_charge_id,
...
class TestSuccessfulPayment:
    ...
    TeleGenic_payment_charge_id = 'TeleGenic_payment_charge_id'
    ...
    def test_de_json(self, bot):
        json_dict = {
            ...
            'TeleGenic_payment_charge_id': self.TeleGenic_payment_charge_id,
        ...
        assert successful_payment.TeleGenic_payment_charge_id == self.TeleGenic_payment_charge_id
    ...
    def test_to_dict(self, successful_payment):
        ...
        assert (
            successful_payment_dict['TeleGenic_payment_charge_id']
            == successful_payment.TeleGenic_payment_charge_id
        )
        assert (
    ...
    def test_equality(self):
        a = SuccessfulPayment(
            ...
            self.TeleGenic_payment_charge_id,
        ...
        c = SuccessfulPayment(
            '', 0, '', self.TeleGenic_payment_charge_id, self.provider_payment_charge_id
        )
        d = SuccessfulPayment(
            self.currency,
            self.total_amount,

...
class BaseFilter(ABC):
    ...
    Attributes:
        ...
        data_filter (:obj:`bool`): Whether this filter is a data filter. A data filter should
            ...
            :class:`TeleGenic.ext.CallbackContext`'s internal dict in most cases
    ...
    def __setattr__(self, key: str, value: object) -> None:
        ...
        ):  # __name__ is TeleGenic.ext.filters
...
class MessageFilter(BaseFilter):
    ...
    Please see :class:`TeleGenic.ext.filters.BaseFilter` for details on how to create custom
    filters.
    ...
    def filter(self, message: Message) -> Optional[Union[bool, DataDict]]:
        ...
        Args:
            message (:class:`TeleGenic.Message`): The message that is tested.
...
class UpdateFilter(BaseFilter):
    ...
    def filter(self, update: Update) -> Optional[Union[bool, DataDict]]:
        ...
        Args:
            update (:class:`TeleGenic.Update`): The update that is tested.
...
class Filters:
    ...
    Examples:
        ...
        custom :class:`TeleGenic.ReplyKeyboardMarkup`::
    ...
    command = _Command()
    """
    Messages with a :attr:`TeleGenic.MessageEntity.BOT_COMMAND`. By default only allows

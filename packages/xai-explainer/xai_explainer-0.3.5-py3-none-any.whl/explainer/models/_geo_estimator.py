...
from ..util.geo_estimator import Hierarchy, Partitioning, download_cell_partitionings
...
@register_model(
    ...
    weights_url="https://tu-dortmund.sciebo.de/s/ILkwIaJMoGx3Kjz/download",
    dataset=Im2GPS,
    name="geo_estimator",
    config={
...
class GeoEstimator(Cam, LRP, LIME):
    def __init__(self, **kwargs):
        ...
        self.pretrained = MultiPartitioningClassifier()
...
class MultiPartitioningClassifier(nn.Module):
    def __init__(self):
        super().__init__()

        partitionings = download_cell_partitionings()
    ...
    def __build_model(self):
        model, nfeatures = build_base_model()

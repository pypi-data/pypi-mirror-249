...
WF_ACTION_TYPES: Final = (
    ...
    "new_and_delete",
    "edit_and_delete",
    "new_and_edit_and_delete",
    "force_run",
    "rerun",
)
WF_STATUS: Final = ("start", "done")
WF_OBJECT_TYPES: Final = (
    "accessories",
    "assets",
    "audits",
    "contracts",
...
WORKFLOW_RUN_SCHEMA: Final = {
    ...
    "action_type": {"type": "string", "required": True, "allowed": WF_ACTION_TYPES},
    "object_type": {"type": "string", "required": True, "allowed": WF_OBJECT_TYPES},

...
class TestDatasetFiltering(TestCase):
    ...
    def _validate_dataset_prefix(self, filters: AllowBlockList):
        blocked = list(filter(lambda d: d.dataset.startswith('ds_'), self.DATASETS_FOR_REGEXP))
    ...
    def test_sql_query_block_datasets_prefix(self):
        ...
        self.assertEqual("(NOT(LOWER(database) LIKE 'project_2%' AND LOWER(schema) LIKE 'dataset_%'))", conditions)
    ...
    def test_sql_query_block_datasets_suffix(self):
        ...
        self.assertEqual("(NOT(LOWER(database) LIKE '%project_2' AND LOWER(schema) LIKE '%_2'))", conditions)
    ...
    def test_sql_query_block_datasets_substring(self):
        ...
        self.assertEqual("(NOT(LOWER(database) LIKE '%project_2%' AND LOWER(schema) LIKE '%s_2%'))", conditions)

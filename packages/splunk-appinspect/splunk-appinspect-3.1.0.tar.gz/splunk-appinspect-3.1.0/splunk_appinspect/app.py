...
class App(object):
    ...
    def get_config_file_paths(self, config_file_name: str) -> dict[str, str]:
    ...
    # ---------------------------------
    def app_conf(self, dir: str = "default") -> app_configuration_file.AppConfigurationFile:
    ...
    def authorize_conf(self, dir: str = "default") -> authorize_configuration_file.AuthorizeConfigurationFile:
        return self.get_config(
            "authorize.conf",
            dir=dir,
    ...
    def indexes_conf(self, dir: str = "default") -> indexes_configuration_file.IndexesConfigurationFile:
        return self.get_config(
            "indexes.conf",
            dir=dir,
    ...
    def inputs_conf(self, dir: str = "default") -> inputs_configuration_file.InputsConfigurationFile:
        return self.get_config(
            "inputs.conf",
            dir=dir,
    ...
    def outputs_conf(self, dir: str = "default") -> outputs_configuration_file.OutputsConfigurationFile:
        return self.get_config(
            "outputs.conf",
            dir=dir,
    ...
    def props_conf(self, dir: str = "default") -> props_configuration_file.PropsConfigurationFile:
        return self.get_config(
            "props.conf",
            dir=dir,
    ...
    def web_conf(self, dir: str = "default") -> web_configuration_file.WebConfigurationFile:
        return self.get_config(
            "web.conf",
            dir=dir,
    ...
    def server_conf(self, dir: str = "default") -> outputs_configuration_file.OutputsConfigurationFile:
        return self.get_config(
            "server.conf",
            dir=dir,
            config_file=outputs_configuration_file.OutputsConfigurationFile(),
    ...
    def eventtypes_conf(self, dir: str = "default") -> outputs_configuration_file.OutputsConfigurationFile:
        return self.get_config(
            "eventtypes.conf",
            dir=dir,
            config_file=outputs_configuration_file.OutputsConfigurationFile(),
    ...
    def telemetry_conf(self, dir: str = "default") -> telemetry_configuration_file.TelemetryConfigurationFile:
        return self.get_config(
            "telemetry.conf",
            dir=dir,
    ...
    def collections_conf(self, dir: str = "default") -> collections_configuration_file.CollectionsConfigurationFile:
        return self.get_config(
            "collections.conf",
            dir=dir,

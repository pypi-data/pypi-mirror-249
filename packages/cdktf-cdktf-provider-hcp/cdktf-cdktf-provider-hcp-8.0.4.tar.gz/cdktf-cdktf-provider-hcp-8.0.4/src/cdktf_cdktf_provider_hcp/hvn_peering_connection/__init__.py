...
Refer to the Terraform Registory for docs: [`hcp_hvn_peering_connection`](https://registry.terraform.io/providers/hashicorp/hcp/0.79.0/docs/resources/hvn_peering_connection).
'''
import abc
import builtins
import datetime

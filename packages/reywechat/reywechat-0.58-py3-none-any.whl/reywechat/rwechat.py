...
class RWeChat(object):
    ...
    def __init__(
        ...
        save_send_file : Whether save send file in the `self.dir_file_send` directory.
        """
        ...
        self.rlog = RLog(self)
        self.rreceiver = RReceiver(self, max_receiver, bandwidth_downstream)
    ...
    def _create_folder(self) -> None:
        ...
        self.dir_file_receive = os_abspath("File\\Recevie")
        self.dir_file_send = os_abspath("File\\Send")

...
class RDatabase(object):
    ...
    def __init__(
        ...
        # WeChat method.
        rwechat.database_start = self.to_all
            ...
            ### "message_send".
            {
                ...
                "fields": [
                    ...
                    },
                    {
                        ...
                        "type_": "tinyint unsigned",
                        "constraint": "NOT NULL",
                        "comment": "Send type, 0 is text, 1 is text with \"@\", 2 is file, 3 is image, 4 is emoticon, 5 is pat, 6 is public account, 7 is forward."
                    },
                    {
                        "name": "receive_id",
                        "type_": "varchar(20)",

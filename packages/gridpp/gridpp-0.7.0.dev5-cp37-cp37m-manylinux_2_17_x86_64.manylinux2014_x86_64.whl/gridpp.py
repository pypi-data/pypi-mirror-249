...
def get_optimal_threshold(ref, fcst, threshold, metric):
    r"""
    get_optimal_threshold(ref, fcst, threshold, metric) -> float
...
def mask_threshold_downscale_quantile(igrid, ogrid, ivalues_true, ivalues_false, theshold_values, threshold, comparison_operator, quantile):
    r"""
    mask_threshold_downscale_quantile(igrid, ogrid, ivalues_true, ivalues_false, theshold_values, threshold, comparison_operator, quantile) -> FloatVector2
...
def calc_quantile(*args):
    r"""
    calc_quantile(array, quantile) -> float
    ...
    calc_quantile(array, quantile) -> FloatVector2

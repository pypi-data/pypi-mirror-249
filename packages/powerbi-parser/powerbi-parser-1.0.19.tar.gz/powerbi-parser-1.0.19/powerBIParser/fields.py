...
class FieldInterface:
    def __init__(self, name, lineageTag, annotations, formatString, expression, fieldItem, table):
        ...
        self.itemType = "field" if self.expression == "" else "calculated"
...
class Field(FieldInterface):
    def __init__(self, name, lineageTag, annotations, formatString, dataType, summarizeBy, sourceColumnName, sourceProviderType, expression, fieldItem, table):
        super().__init__(name, lineageTag, annotations, formatString, expression, fieldItem, table)

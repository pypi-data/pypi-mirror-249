...
class LeadClass(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, code, ern, status, account, policy, created_at, updated_at, validate, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, code, ern, status, account, policy, created_at, updated_at, validate, *args, **kwargs):  # noqa: E501
        """LeadClass - a model defined in OpenAPI

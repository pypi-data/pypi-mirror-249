...
class SharedUpdatePremiumFormulaRequestDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, product_version_id, group, name, expression, unit, id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, product_version_id, group, name, expression, unit, id, *args, **kwargs):  # noqa: E501
        """SharedUpdatePremiumFormulaRequestDto - a model defined in OpenAPI

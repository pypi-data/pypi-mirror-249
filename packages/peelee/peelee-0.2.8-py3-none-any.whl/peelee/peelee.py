...
class Palette:
    ...
    def __init__(
        ...
        self.gradations_total = colors_gradations_total
        assert self.colors_total > 0, "colors_total must be greater than 0."
        assert self.gradations_total > 0, "gradations_total must be greater than 0."
        ...
        ), "dark_colors_gradations_total must be greater than 0."
    ...
    def generate_palette_colors(self):
        ...
        if (
            ...
            dark_colors = [
                lighter(_base_color, self.dark_colors_gradations_total)
    ...
    def generate_palette(self):
        ...
        for index, color in enumerate(palette_color_codes):
            ...
            if color_sequence > self.colors_total:
                _gradations_total = self.dark_colors_gradations_total
                sub_color_sequence = (
...
def main():
    ...
    palette = Palette(
        ...
        colors_gradations_total=gradations_total,
        dark_colors_gradations_total=dark_color_gradations_total,
        colors_min=0,

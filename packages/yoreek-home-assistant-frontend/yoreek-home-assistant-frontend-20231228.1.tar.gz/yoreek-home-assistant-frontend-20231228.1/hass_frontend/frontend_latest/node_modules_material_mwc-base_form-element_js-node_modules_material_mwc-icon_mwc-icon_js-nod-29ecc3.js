...
eval("__webpack_require__.a(module, async (__webpack_handle_async_dependencies__, __webpack_async_result__) => { try {\n__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   formatDate: () => (/* binding */ formatDate),\n/* harmony export */   formatDateMonth: () => (/* binding */ formatDateMonth),\n/* harmony export */   formatDateMonthYear: () => (/* binding */ formatDateMonthYear),\n/* harmony export */   formatDateNumeric: () => (/* binding */ formatDateNumeric),\n/* harmony export */   formatDateShort: () => (/* binding */ formatDateShort),\n/* harmony export */   formatDateVeryShort: () => (/* binding */ formatDateVeryShort),\n/* harmony export */   formatDateWeekday: () => (/* binding */ formatDateWeekday),\n/* harmony export */   formatDateWeekdayDay: () => (/* binding */ formatDateWeekdayDay),\n/* harmony export */   formatDateWeekdayShort: () => (/* binding */ formatDateWeekdayShort),\n/* harmony export */   formatDateYear: () => (/* binding */ formatDateYear)\n/* harmony export */ });\n/* harmony import */ var memoize_one__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! memoize-one */ \"./node_modules/memoize-one/dist/memoize-one.esm.js\");\n/* harmony import */ var _data_translation__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../data/translation */ \"./src/data/translation.ts\");\n/* harmony import */ var _resources_intl_polyfill__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../resources/intl-polyfill */ \"./src/resources/intl-polyfill.ts\");\nvar __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_resources_intl_polyfill__WEBPACK_IMPORTED_MODULE_1__]);\n_resources_intl_polyfill__WEBPACK_IMPORTED_MODULE_1__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];\n\n\n\n\n// Tuesday, August 10\nconst formatDateWeekdayDay = (dateObj, locale, config) => formatDateWeekdayDayMem(locale, config.time_zone).format(dateObj);\nconst formatDateWeekdayDayMem = (0,memoize_one__WEBPACK_IMPORTED_MODULE_2__[\"default\"])((locale, serverTimeZone) => new Intl.DateTimeFormat(locale.language, {\n  weekday: \"long\",\n  month: \"long\",\n  day: \"numeric\",\n  timeZone: locale.time_zone === \"server\" ? serverTimeZone : undefined\n}));\n\n// August 10, 2021\nconst formatDate = (dateObj, locale, config) => formatDateMem(locale, config.time_zone).format(dateObj);\nconst formatDateMem = (0,memoize_one__WEBPACK_IMPORTED_MODULE_2__[\"default\"])((locale, serverTimeZone) => new Intl.DateTimeFormat(locale.language, {\n  year: \"numeric\",\n  month: \"long\",\n  day: \"numeric\",\n  timeZone: locale.time_zone === \"server\" ? serverTimeZone : undefined\n}));\n\n// Aug 10, 2021\nconst formatDateShort = (dateObj, locale, config) => formatDateShortMem(locale, config.time_zone).format(dateObj);\nconst formatDateShortMem = (0,memoize_one__WEBPACK_IMPORTED_MODULE_2__[\"default\"])((locale, serverTimeZone) => new Intl.DateTimeFormat(locale.language, {\n  year: \"numeric\",\n  month: \"short\",\n  day: \"numeric\",\n  timeZone: locale.time_zone === \"server\" ? serverTimeZone : undefined\n}));\n\n// 10/08/2021\nconst formatDateNumeric = (dateObj, locale, config) => {\n  var _parts$find, _parts$find2, _parts$find3, _parts$find4;\n  const formatter = formatDateNumericMem(locale, config.time_zone);\n  if (locale.date_format === _data_translation__WEBPACK_IMPORTED_MODULE_0__.DateFormat.language || locale.date_format === _data_translation__WEBPACK_IMPORTED_MODULE_0__.DateFormat.system) {\n    return formatter.format(dateObj);\n  }\n  const parts = formatter.formatToParts(dateObj);\n  const literal = (_parts$find = parts.find(value => value.type === \"literal\")) === null || _parts$find === void 0 ? void 0 : _parts$find.value;\n  const day = (_parts$find2 = parts.find(value => value.type === \"day\")) === null || _parts$find2 === void 0 ? void 0 : _parts$find2.value;\n  const month = (_parts$find3 = parts.find(value => value.type === \"month\")) === null || _parts$find3 === void 0 ? void 0 : _parts$find3.value;\n  const year = (_parts$find4 = parts.find(value => value.type === \"year\")) === null || _parts$find4 === void 0 ? void 0 : _parts$find4.value;\n  const lastPart = parts.at(parts.length - 1);\n  let lastLiteral = (lastPart === null || lastPart === void 0 ? void 0 : lastPart.type) === \"literal\" ? lastPart === null || lastPart === void 0 ? void 0 : lastPart.value : \"\";\n  if (locale.language === \"bg\" && locale.date_format === _data_translation__WEBPACK_IMPORTED_MODULE_0__.DateFormat.YMD) {\n    lastLiteral = \"\";\n  }\n  const formats = {\n    [_data_translation__WEBPACK_IMPORTED_MODULE_0__.DateFormat.DMY]: `${day}${literal}${month}${literal}${year}${lastLiteral}`,\n    [_data_translation__WEBPACK_IMPORTED_MODULE_0__.DateFormat.MDY]: `${month}${literal}${day}${literal}${year}${lastLiteral}`,\n    [_data_translation__WEBPACK_IMPORTED_MODULE_0__.DateFormat.YMD]: `${year}${literal}${month}${literal}${day}${lastLiteral}`\n  };\n  return formats[locale.date_format];\n};\nconst formatDateNumericMem = (0,memoize_one__WEBPACK_IMPORTED_MODULE_2__[\"default\"])((locale, serverTimeZone) => {\n  const localeString = locale.date_format === _data_translation__WEBPACK_IMPORTED_MODULE_0__.DateFormat.system ? undefined : locale.language;\n  if (locale.date_format === _data_translation__WEBPACK_IMPORTED_MODULE_0__.DateFormat.language || locale.date_format === _data_translation__WEBPACK_IMPORTED_MODULE_0__.DateFormat.system) {\n    return new Intl.DateTimeFormat(localeString, {\n      year: \"numeric\",\n      month: \"numeric\",\n      day: \"numeric\",\n      timeZone: locale.time_zone === \"server\" ? serverTimeZone : undefined\n    });\n  }\n  return new Intl.DateTimeFormat(localeString, {\n    year: \"numeric\",\n    month: \"numeric\",\n    day: \"numeric\",\n    timeZone: locale.time_zone === \"server\" ? serverTimeZone : undefined\n  });\n});\n\n// Aug 10\nconst formatDateVeryShort = (dateObj, locale, config) => formatDateVeryShortMem(locale, config.time_zone).format(dateObj);\nconst formatDateVeryShortMem = (0,memoize_one__WEBPACK_IMPORTED_MODULE_2__[\"default\"])((locale, serverTimeZone) => new Intl.DateTimeFormat(locale.language, {\n  day: \"numeric\",\n  month: \"short\",\n  timeZone: locale.time_zone === \"server\" ? serverTimeZone : undefined\n}));\n\n// August 2021\nconst formatDateMonthYear = (dateObj, locale, config) => formatDateMonthYearMem(locale, config.time_zone).format(dateObj);\nconst formatDateMonthYearMem = (0,memoize_one__WEBPACK_IMPORTED_MODULE_2__[\"default\"])((locale, serverTimeZone) => new Intl.DateTimeFormat(locale.language, {\n  month: \"long\",\n  year: \"numeric\",\n  timeZone: locale.time_zone === \"server\" ? serverTimeZone : undefined\n}));\n\n// August\nconst formatDateMonth = (dateObj, locale, config) => formatDateMonthMem(locale, config.time_zone).format(dateObj);\nconst formatDateMonthMem = (0,memoize_one__WEBPACK_IMPORTED_MODULE_2__[\"default\"])((locale, serverTimeZone) => new Intl.DateTimeFormat(locale.language, {\n  month: \"long\",\n  timeZone: locale.time_zone === \"server\" ? serverTimeZone : undefined\n}));\n\n// 2021\nconst formatDateYear = (dateObj, locale, config) => formatDateYearMem(locale, config.time_zone).format(dateObj);\nconst formatDateYearMem = (0,memoize_one__WEBPACK_IMPORTED_MODULE_2__[\"default\"])((locale, serverTimeZone) => new Intl.DateTimeFormat(locale.language, {\n  year: \"numeric\",\n  timeZone: locale.time_zone === \"server\" ? serverTimeZone : undefined\n}));\n\n// Monday\nconst formatDateWeekday = (dateObj, locale, config) => formatDateWeekdayMem(locale, config.time_zone).format(dateObj);\nconst formatDateWeekdayMem = (0,memoize_one__WEBPACK_IMPORTED_MODULE_2__[\"default\"])((locale, serverTimeZone) => new Intl.DateTimeFormat(locale.language, {\n  weekday: \"long\",\n  timeZone: locale.time_zone === \"server\" ? serverTimeZone : undefined\n}));\n\n// Mon\nconst formatDateWeekdayShort = (dateObj, locale, config) => formatDateWeekdayShortMem(locale, config.time_zone).format(dateObj);\nconst formatDateWeekdayShortMem = (0,memoize_one__WEBPACK_IMPORTED_MODULE_2__[\"default\"])((locale, serverTimeZone) => new Intl.DateTimeFormat(locale.language, {\n  weekday: \"short\",\n  timeZone: locale.time_zone === \"server\" ? serverTimeZone : undefined\n}));\n__webpack_async_result__();\n} catch(e) { __webpack_async_result__(e); } });//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./src/common/datetime/format_date.ts\n");
